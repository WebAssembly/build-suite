(module
  ...
  (import $ka "env" "_pthread_cleanup_pop" (param i32))
  (import $la "env" "_nanosleep" (param i32 i32) (result i32))
  (import $ma "env" "___cxa_atexit" (param i32 i32 i32) (result i32))
  ...
  (import $ta "env" "_emscripten_cancel_main_loop")
  (import $ua "env" "___syscall146" (param i32 i32) (result i32))
  (import $wa "env" "_emscripten_memcpy_big" (param i32 i32 i32) (result i32))
  (import $xa "env" "___syscall54" (param i32 i32) (result i32))
  (import $ya "env" "___syscall140" (param i32 i32) (result i32))
  (import $za "env" "_pthread_cleanup_push" (param i32 i32))
  (import $Aa "env" "_emscripten_set_main_loop" (param i32 i32 i32))
  (import $f64-to-int "asm2wasm" "f64-to-int" (param f64) (result i32))
  (export "_i64Subtract" $Fb)
  (export "_free" $Db)
  (export "_main" $Ra)
  (export "_i64Add" $Gb)
  (export "_pthread_self" $Lb)
  (export "_memset" $Hb)
  (export "_malloc" $Cb)
  (export "_memcpy" $Kb)
  (export "_bitshift64Lshr" $Ib)
  (export "_bitshift64Shl" $Jb)
  (export "__GLOBAL__sub_I_CoreHello_cc" $Ta)
  (export "__GLOBAL__sub_I_Log_cc" $bb)
  (export "runPostSets" $Eb)
  (export "stackAlloc" $Ja)
  (export "stackSave" $Ka)
  (export "stackRestore" $La)
  (export "establishStackSpace" $Ma)
  (export "setThrew" $Na)
  (export "setTempRet0" $Oa)
  (export "getTempRet0" $Pa)
  (export "dynCall_iiii" $Vb)
  (export "dynCall_vi" $Wb)
  (export "dynCall_vii" $Xb)
  (export "dynCall_ii" $Yb)
  (export "dynCall_v" $Zb)
  (export "dynCall_viiii" $_b)
  (table $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $rb $qb $$b $$b $$b $$b $ob $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $$b $ac $ac $ac $ac $ac $ac $ac $ac $Sa $$a $ac $ac $ac $ac $Qa $cb $pb $ac $ac $ac $ac $ac $ac $ac $ac $ac $ac $ac $ac $ac $ac $ac $bc $cc $Ua $Va $Wa $Xa $Ya $Za $_a $cc $cc $nb $cc $cc $cc $cc $cc $dc $dc $dc $dc $dc $dc $dc $dc $dc $dc $dc $dc $dc $ab $dc $dc $ec)
  ...
  (func $ub (param $e i32) (param $f i32) (param $g i32) (param $j i32) (param $l i32) (result i32)
    (local $n i32)
    (local $o i32)
    (local $q i32)
    (local $r i32)
  ...
  (func $Ra (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $f i32)
    (local $p i32)
    (local $g i32)
  ...
  (func $Ub (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32) (result i32)
    (local $i i32)
    (local $g i32)
    (local $n i32)
    (local $k i32)
                              ...
                              (block $switch-case$9
                                (block $switch-case$8
                                  (block $switch-case$7
                                    (block $switch-case$6
                                      (block $switch-case$5
                                        (br_table $switch-case$5 $switch-case$6 $switch-case$7 $switch-case$8 $switch-case$9 $switch-case$10 $switch-case$11 $switch-case$12 $switch-default$13
                                          (i32.sub
                                            (get_local $j)
                                            (i32.const 0)
                                          )
                            ...
                            (block $switch-case$17
                              (block $switch-case$16
                                (block $switch-case$15
                                  (br_table $switch-case$15 $switch-case$16 $switch-case$17 $switch-case$18 $switch-case$19 $switch-case$20 $switch-case$21 $switch-case$22 $switch-default$23
                                    (i32.sub
                                      (get_local $j)
                                      (i32.const 0)
                                    )
                          ...
                          (block $switch-case$27
                            (block $switch-case$26
                              (block $switch-case$25
                                (br_table $switch-case$25 $switch-case$26 $switch-case$27 $switch-case$28 $switch-case$29 $switch-case$30 $switch-case$31 $switch-case$32 $switch-default$33
                                  (i32.sub
                                    (i32.load
                                      (get_local $n)
                                    )
  ...
  (func $jb (param $b i32) (param $d i32)
    (local $e i32)
    (local $f i32)
    (local $m i32)
    (local $k i32)
  ...
  (func $xb (param $a i32) (param $b i32) (param $d i32)
    (local $e i32)
    (local $f i32)
    (local $g f64)
    (block $label$break$a
  ...
  (func $mb (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $g i32)
    (local $l i32)
    (local $j i32)
  ...
  (func $ob (param $a i32) (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $k i32)
    (local $g i32)
    (local $n i32)
  ...
  (func $lb (param $b i32) (param $d i32) (result i32)
    (local $e i32)
    (local $j i32)
    (local $g i32)
    (local $h i32)
  ...
  (func $tb (param $b i32) (param $d i32) (param $e i32)
    (local $f i32)
    (local $q i32)
    (local $p i32)
    (local $n i32)
  ...
  (func $fb (param $b i32) (param $d i32)
    (local $e i32)
    (local $k i32)
    (local $f i32)
    (local $j i32)
  ...
  (func $eb (param $b i32) (param $d i32)
    (local $e i32)
    (local $k i32)
    (local $f i32)
    (local $j i32)
  ...
  (func $db (param $b i32) (param $d i32)
    (local $e i32)
    (local $k i32)
    (local $f i32)
    (local $j i32)
  ...
  (func $vb (param $b i32) (param $d i32) (param $e i32)
    (local $h i32)
    (local $g i32)
    (local $f i32)
    (local $i i32)
  ...
  (func $Ab (param $b i32) (param $d i32) (result i32)
    (block $do-once$0
      (if
        (i32.eqz
          (get_local $b)
  ...
  (func $Qb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $h i32)
    (local $g i32)
    (local $j i32)
    (local $l i32)
  ...
  (func $zb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (param $f i32)
    (local $g i32)
    (local $h i32)
    (set_local $h
      (i32.load
  ...
  (func $qb (param $a i32) (param $b i32) (param $d i32) (result i32)
    (local $h i32)
    (local $g i32)
    (local $e i32)
    (local $f i32)
  ...
  (func $Pb (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (local $j i32)
    (local $i i32)
    (local $f i32)
    (local $e i32)
  ...
  (func $Kb (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (if
      (i32.ge_s
        (get_local $e)
  ...
  (func $yb (param $b i32) (param $c i32) (param $d i32) (result i32)
    (local $e i32)
    (if
      (i32.or
        (i32.gt_u
  ...
  (func $Hb (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $h i32)
    (local $f i32)
    (local $i i32)
    (local $g i32)
  ...
  (func $wb (param $b i32) (result i32)
    (local $d i32)
    (local $e i32)
    (set_local $d
      (i32.add
  ...
  (func $rb (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $g
      (i32.load
  ...
  (func $Nb (param $b i32) (result i32)
    (local $c i32)
    (set_local $c
      (i32.load8_s
        (i32.add
  ...
  (func $Tb (param $a i32) (param $b i32) (param $d i32) (param $e i32) (result i32)
    (local $f i32)
    (local $g i32)
    (set_local $g
      (i32.load
  ...
  (func $Fb (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $d
      (i32.sub
        (i32.sub
          (get_local $b)
  ...
  (func $Gb (param $a i32) (param $b i32) (param $c i32) (param $d i32) (result i32)
    (set_local $c
      (i32.add
        (get_local $a)
        (get_local $c)
  ...
  (func $_b (param $a i32) (param $b i32) (param $c i32) (param $d i32) (param $e i32)
    (call_indirect $FUNCSIG$viiii
      (i32.add
        (i32.and
          (get_local $a)
  ...
  (func $Xb (param $a i32) (param $b i32) (param $c i32)
    (call_indirect $FUNCSIG$vii
      (i32.add
        (i32.and
          (get_local $a)
  ...
  (func $ec (param $a i32) (param $b i32) (param $c i32) (param $d i32)
    (call_import $ca
      (i32.const 5)
    )
  )
  (func $$b (param $a i32) (param $b i32) (param $c i32) (result i32)
    (call_import $ca
      (i32.const 0)
    )
    (return
  ...
  (func $Yb (param $a i32) (param $b i32) (result i32)
    (return
      (call_indirect $FUNCSIG$ii
        (i32.add
          (i32.and
  ...
  (func $Wb (param $a i32) (param $b i32)
    (call_indirect $FUNCSIG$vi
      (i32.add
        (i32.and
          (get_local $a)
  ...
  (func $bc (param $a i32) (param $b i32)
    (call_import $ca
      (i32.const 2)
    )
  )
  (func $cc (param $a i32) (result i32)
    (call_import $ca
      (i32.const 3)
    )
    (return
