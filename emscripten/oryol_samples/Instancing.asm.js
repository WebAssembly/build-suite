Module["asm"] =  (function(global,env,buffer) {
 ...
 var Ha = env._glDrawElementsInstanced;
 var Ia = env.___resumeException;
 var Ja = env._emscripten_get_canvas_size;
 var Ka = env._emscripten_request_fullscreen_strategy;
 var La = env._glGenBuffers;
 var Ma = env._glShaderSource;
 var Na = env.___cxa_atexit;
 var Oa = env._pthread_cleanup_push;
 var Pa = env.___syscall140;
 var Qa = env.___syscall146;
 var Ra = env._pthread_cleanup_pop;
 var Sa = env._glVertexAttribPointer;
 var Ta = env.__restoreHiddenElements;
 var Ua = env.___cxa_find_matching_catch;
 var Va = env._glDrawElements;
 var Wa = env._glDepthMask;
 var Xa = env._glBufferSubData;
 var Ya = env._glViewport;
 var Za = env._glDeleteTextures;
 var _a = env._glDepthFunc;
 var $a = env._glStencilOpSeparate;
 var ab = env._emscripten_set_canvas_size;
 var bb = env._glUniform3f;
 var cb = env._nanosleep;
 var db = env._glCompressedTexImage2D;
 var eb = env._glEnable;
 var fb = env._llvm_trap;
 var gb = env._glGenTextures;
 var hb = env._glGetIntegerv;
 var ib = env._glGetString;
 var jb = env._glDrawArraysInstanced;
 var kb = env.emscriptenWebGLGet;
 var lb = env._glStencilMaskSeparate;
 var mb = env._emscripten_get_now;
 var nb = env._glAttachShader;
 var ob = env.__registerRestoreOldStyle;
 var pb = env.emscriptenWebGLGetTexPixelData;
 var qb = env.___syscall6;
 var rb = env._glBindFramebuffer;
 var sb = env._emscripten_set_devicemotion_callback;
 var tb = env._glUniform2f;
 var ub = env._glCullFace;
 var vb = env._emscripten_set_keypress_callback;
 var wb = env._glDeleteFramebuffers;
 var xb = env._emscripten_webgl_create_context;
 var yb = env._glClearColor;
 var zb = env.___cxa_allocate_exception;
 var Ab = env._emscripten_set_keyup_callback;
 var Bb = env._glBlendFuncSeparate;
 var Cb = env._emscripten_set_mouseup_callback;
 var Db = env._glClearDepthf;
 var Eb = env._emscripten_set_deviceorientation_callback;
 var Fb = env._glBindTexture;
 var Gb = env._glUniform1f;
 var Hb = env._glUniform1i;
 var Ib = env._glDrawArrays;
 var Jb = env._glCreateShader;
 var Kb = env._llvm_fabs_f32;
 var Lb = env._emscripten_webgl_init_context_attributes;
 var Mb = env._glActiveTexture;
 var Nb = env.__setLetterbox;
 var Ob = env._glFrontFace;
 var Pb = env._glCompileShader;
 var Qb = env._emscripten_exit_pointerlock;
 var Rb = env._glEnableVertexAttribArray;
 var Sb = env._abort;
 var Tb = env._glDeleteBuffers;
 var Ub = env._glBufferData;
 var Vb = env._glTexImage2D;
 var Wb = env._glDeleteShader;
 var Xb = env._glGetProgramiv;
 var Yb = env._emscripten_request_pointerlock;
 var Zb = env.emscriptenWebGLComputeImageSize;
 var _b = env._emscripten_set_keydown_callback;
 var $b = env.___gxx_personality_v0;
 var ac = env._emscripten_set_touchcancel_callback;
 var bc = env._emscripten_set_mousemove_callback;
 var cc = env._glDeleteRenderbuffers;
 var dc = env._usleep;
 var ec = env._glLinkProgram;
 var fc = env._emscripten_set_touchend_callback;
 var gc = env._glGetShaderiv;
 var hc = env._glGetUniformLocation;
 var ic = env._emscripten_cancel_main_loop;
 var jc = env._glClear;
 var kc = env._glUniform4fv;
 var lc = env._glBindAttribLocation;
 var mc = env._emscripten_webgl_destroy_context;
 ...
 var rc = env._emscripten_set_main_loop;
 var sc = env.___cxa_throw;
 var tc = env._glColorMask;
 var uc = env.__hideEverythingExceptGivenElement;
 var vc = env._glDisable;
 var wc = env._glTexParameteri;
 var xc = env._glBlendColor;
 var yc = env._atexit;
 var zc = env._glStencilMask;
...
function od(f) {
 f = f | 0;
 var h = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0, C = 0, E = 0, F = 0, G = 0, H = 0, I = 0, J = 0, K = 0, L = 0, M = 0, N = 0, O = 0, P = 0;
 M = c[f + 5072 >> 2] | 0;
 J = c[f + 6984 >> 2] | 0;
 K = c[f + 7e3 >> 2] | 0;
 L = c[f + 7008 >> 2] | 0;
 ...
 P = c[f + 11048 >> 2] | 0;
 a : {
  do if ((c[(f + 4032 | 0) + 4 >> 2] | 0) == -1) {
   v = c[(x + 1448 | 0) >> 2] | 0;
   c[(x + 1448 | 0) >> 2] = v + 1;
   O = c[(x + 1488 | 0) >> 2] | 0;
   w = b[(c[x + 1480 >> 2] | 0) + (O << 1) >> 1] | 0;
   c[(x + 1488 | 0) >> 2] = O + 1;
   O = Uf(e[x + 1452 >> 1] | 0, 0, 16) | 0;
   v = v | D;
   c[(f + 4032 | 0) >> 2] = O | w & 65535;
   c[(f + 4032 | 0) + 4 >> 2] = v;
   c[(f + 4440 | 0) >> 2] = O | w & 65535;
   c[(f + 4440 | 0) + 4 >> 2] = v;
   c[(f + 4424 | 0) >> 2] = c[(c[x + 1168 >> 2] | 0) + ((c[x + 1180 >> 2] | 0) + -1 << 2) >> 2];
   te(x + 1192 | 0, (f + 200 | 0) + 92 | 0, f + 4440 | 0, f + 4424 | 0);
   v = (c[(x + 1464 | 0) >> 2] | 0) + (e[(f + 4032 | 0) >> 1] | 0) | 0;
   w = c[(x + 1456 | 0) >> 2] | 0;
   c[w + (v * 400 | 0) + 8 >> 2] = 1;
   c[w + (v * 400 | 0) + 12 >> 2] = c[(x + 1444 | 0) >> 2];
   if ((w + (v * 400 | 0) | 0 | 0) != (f + 4032 | 0 | 0)) {
    O = c[(f + 4032 | 0) + 4 >> 2] | 0;
    c[(w + (v * 400 | 0) | 0) >> 2] = c[(f + 4032 | 0) >> 2];
    c[(w + (v * 400 | 0) | 0) + 4 >> 2] = O;
   }
   O = c[(f + 200 | 0) + 4 >> 2] | 0;
   c[(w + (v * 400 | 0) + 16 | 0) >> 2] = c[(f + 200 | 0) >> 2];
   c[(w + (v * 400 | 0) + 16 | 0) + 4 >> 2] = O;
   O = b[(f + 200 | 0) + 8 >> 1] | 0;
   a[(w + (v * 400 | 0) + 24 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 24 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 10 >> 1] | 0;
   a[(w + (v * 400 | 0) + 26 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 26 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 12 >> 1] | 0;
   a[(w + (v * 400 | 0) + 28 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 28 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 14 >> 1] | 0;
   a[(w + (v * 400 | 0) + 30 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 30 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 16 >> 1] | 0;
   a[(w + (v * 400 | 0) + 32 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 32 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 18 >> 1] | 0;
   a[(w + (v * 400 | 0) + 34 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 34 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 20 >> 1] | 0;
   a[(w + (v * 400 | 0) + 36 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 36 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 22 >> 1] | 0;
   a[(w + (v * 400 | 0) + 38 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 38 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 24 >> 1] | 0;
   a[(w + (v * 400 | 0) + 40 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 40 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 26 >> 1] | 0;
   a[(w + (v * 400 | 0) + 42 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 42 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 28 >> 1] | 0;
   a[(w + (v * 400 | 0) + 44 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 44 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 30 >> 1] | 0;
   a[(w + (v * 400 | 0) + 46 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 46 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 32 >> 1] | 0;
   a[(w + (v * 400 | 0) + 48 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 48 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 34 >> 1] | 0;
   a[(w + (v * 400 | 0) + 50 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 50 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 36 >> 1] | 0;
   a[(w + (v * 400 | 0) + 52 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 52 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 38 >> 1] | 0;
   a[(w + (v * 400 | 0) + 54 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 54 | 0) + 1 >> 0] = O >> 8;
   O = b[(f + 200 | 0) + 40 >> 1] | 0;
   a[(w + (v * 400 | 0) + 56 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 56 | 0) + 1 >> 0] = O >> 8;
   a[w + (v * 400 | 0) + 58 >> 0] = a[(f + 200 | 0) + 42 >> 0] | 0;
   a[w + (v * 400 | 0) + 59 >> 0] = a[(f + 200 | 0) + 43 >> 0] | 0;
   a[w + (v * 400 | 0) + 60 >> 0] = a[(f + 200 | 0) + 44 >> 0] | 0;
   a[w + (v * 400 | 0) + 61 >> 0] = a[(f + 200 | 0) + 45 >> 0] | 0;
   a[w + (v * 400 | 0) + 62 >> 0] = a[(f + 200 | 0) + 46 >> 0] | 0;
   a[w + (v * 400 | 0) + 63 >> 0] = a[(f + 200 | 0) + 47 >> 0] | 0;
   a[w + (v * 400 | 0) + 64 >> 0] = a[(f + 200 | 0) + 48 >> 0] | 0;
   a[w + (v * 400 | 0) + 65 >> 0] = a[(f + 200 | 0) + 49 >> 0] | 0;
   a[w + (v * 400 | 0) + 66 >> 0] = a[(f + 200 | 0) + 50 >> 0] | 0;
   a[w + (v * 400 | 0) + 67 >> 0] = a[(f + 200 | 0) + 51 >> 0] | 0;
   a[w + (v * 400 | 0) + 68 >> 0] = a[(f + 200 | 0) + 52 >> 0] | 0;
   a[w + (v * 400 | 0) + 69 >> 0] = a[(f + 200 | 0) + 53 >> 0] | 0;
   a[w + (v * 400 | 0) + 70 >> 0] = a[(f + 200 | 0) + 54 >> 0] | 0;
   a[w + (v * 400 | 0) + 71 >> 0] = a[(f + 200 | 0) + 55 >> 0] | 0;
   a[w + (v * 400 | 0) + 72 >> 0] = a[(f + 200 | 0) + 56 >> 0] | 0;
   a[w + (v * 400 | 0) + 73 >> 0] = a[(f + 200 | 0) + 57 >> 0] | 0;
   a[w + (v * 400 | 0) + 74 >> 0] = a[(f + 200 | 0) + 58 >> 0] | 0;
   a[w + (v * 400 | 0) + 75 >> 0] = a[(f + 200 | 0) + 59 >> 0] | 0;
   a[w + (v * 400 | 0) + 76 >> 0] = a[(f + 200 | 0) + 60 >> 0] | 0;
   a[w + (v * 400 | 0) + 77 >> 0] = a[(f + 200 | 0) + 61 >> 0] | 0;
   a[w + (v * 400 | 0) + 78 >> 0] = a[(f + 200 | 0) + 62 >> 0] | 0;
   a[w + (v * 400 | 0) + 79 >> 0] = a[(f + 200 | 0) + 63 >> 0] | 0;
   a[w + (v * 400 | 0) + 80 >> 0] = a[(f + 200 | 0) + 64 >> 0] | 0;
   a[w + (v * 400 | 0) + 81 >> 0] = a[(f + 200 | 0) + 65 >> 0] | 0;
   a[w + (v * 400 | 0) + 82 >> 0] = a[(f + 200 | 0) + 66 >> 0] | 0;
   a[w + (v * 400 | 0) + 83 >> 0] = a[(f + 200 | 0) + 67 >> 0] | 0;
   a[w + (v * 400 | 0) + 84 >> 0] = a[(f + 200 | 0) + 68 >> 0] | 0;
   a[w + (v * 400 | 0) + 85 >> 0] = a[(f + 200 | 0) + 69 >> 0] | 0;
   a[w + (v * 400 | 0) + 86 >> 0] = a[(f + 200 | 0) + 70 >> 0] | 0;
   a[w + (v * 400 | 0) + 87 >> 0] = a[(f + 200 | 0) + 71 >> 0] | 0;
   a[w + (v * 400 | 0) + 88 >> 0] = a[(f + 200 | 0) + 72 >> 0] | 0;
   a[w + (v * 400 | 0) + 89 >> 0] = a[(f + 200 | 0) + 73 >> 0] | 0;
   O = b[(f + 200 | 0) + 74 >> 1] | 0;
   a[(w + (v * 400 | 0) + 90 | 0) >> 0] = O;
   a[(w + (v * 400 | 0) + 90 | 0) + 1 >> 0] = O >> 8;
   c[(w + (v * 400 | 0) + 92 | 0) >> 2] = c[((f + 200 | 0) + 76 | 0) >> 2];
   c[(w + (v * 400 | 0) + 92 | 0) + 4 >> 2] = c[((f + 200 | 0) + 76 | 0) + 4 >> 2];
   c[(w + (v * 400 | 0) + 92 | 0) + 8 >> 2] = c[((f + 200 | 0) + 76 | 0) + 8 >> 2];
   a[(w + (v * 400 | 0) + 92 | 0) + 12 >> 0] = a[((f + 200 | 0) + 76 | 0) + 12 >> 0] | 0;
   if ((w + (v * 400 | 0) + 16 | 0 | 0) == (f + 200 | 0 | 0)) m = c[(f + 200 | 0) + 96 >> 2] | 0; else {
    c[(w + (v * 400 | 0) + 108 | 0) >> 2] = 0;
    Ve(w + (v * 400 | 0) + 108 | 0, (f + 200 | 0) + 92 | 0);
    m = c[(f + 200 | 0) + 96 >> 2] | 0;
    O = c[((f + 200 | 0) + 104 | 0) + 4 >> 2] | 0;
    c[(w + (v * 400 | 0) + 120 | 0) >> 2] = c[((f + 200 | 0) + 104 | 0) >> 2];
    c[(w + (v * 400 | 0) + 120 | 0) + 4 >> 2] = O;
   }
   c[w + (v * 400 | 0) + 112 >> 2] = m;
   G = w + (v * 400 | 0) + 128 | 0;
   O = (f + 200 | 0) + 112 | 0;
   ...
   a[(w + (v * 400 | 0) + 128 | 0) + 76 >> 0] = a[((f + 200 | 0) + 112 | 0) + 76 >> 0] | 0;
   Jd(w + (v * 400 | 0) | 0);
   H = c[w + (v * 400 | 0) + 136 >> 2] | 0;
   c[(w + (v * 400 | 0) + 296 | 0) >> 2] = H;
   if ((H | 0) > 0) {
    m = 0;
    do {
     s = w + (v * 400 | 0) + 140 + (m << 3) | 0;
     G = c[s + 4 >> 2] | 0;
     H = w + (v * 400 | 0) + 300 + (m << 3) | 0;
     c[H >> 2] = c[s >> 2];
     c[H + 4 >> 2] = G;
     m = m + 1 | 0;
    } while ((m | 0) < (c[(w + (v * 400 | 0) + 296 | 0) >> 2] | 0));
   }
   b : do if ((c[(w + (v * 400 | 0) + 92 | 0) >> 2] | 0) > 0) {
    s = $(d[w + (v * 400 | 0) + 279 >> 0] | 0, c[w + (v * 400 | 0) + 208 >> 2] | 0) | 0;
    q = c[(w + (v * 400 | 0) + 280 | 0) >> 2] | 0;
    a[(w + (v * 400 | 0) + 368 | 0) >> 0] = (q | 0) == 2 ? 2 : 1;
    r = c[(w + (v * 400 | 0) + 128 | 0) >> 2] | 0;
    r = (r | 0) == -1 ? 0 : u + r | 0;
    m = 0;
    c : while (1) {
     p = m & 255;
     ...
     Ub(34962, s | 0, r | 0, n | 0);
     Nd(c[(x + 1312 | 0) >> 2] | 0);
     c[w + (v * 400 | 0) + 372 + (p << 2) >> 2] = c[(f + 4768 | 0) >> 2];
     m = m + 1 << 24 >> 24;
     if ((m & 255) >= (d[(w + (v * 400 | 0) + 368 | 0) >> 0] | 0)) break b;
     q = c[(w + (v * 400 | 0) + 280 | 0) >> 2] | 0;
    }
    Je(5601, f + 4832 | 0);
    fb();
   } while (0);
   m = c[w + (v * 400 | 0) + 288 >> 2] | 0;
   d : do if (m | 0) {
    n = c[w + (v * 400 | 0) + 284 >> 2] | 0;
    switch (m | 0) {
    case 2:
     {
      t = 4;
    ...
    s = $(t, n) | 0;
    q = c[(w + (v * 400 | 0) + 292 | 0) >> 2] | 0;
    a[(w + (v * 400 | 0) + 384 | 0) >> 0] = (q | 0) == 2 ? 2 : 1;
    r = c[w + (v * 400 | 0) + 132 >> 2] | 0;
    r = (r | 0) == -1 ? 0 : u + r | 0;
    m = 0;
    e : while (1) {
     p = m & 255;
     ...
     Ub(34963, s | 0, r | 0, n | 0);
     Nd(c[(x + 1312 | 0) >> 2] | 0);
     c[w + (v * 400 | 0) + 388 + (p << 2) >> 2] = c[(f + 4768 | 0) >> 2];
     m = m + 1 << 24 >> 24;
     if ((m & 255) >= (d[(w + (v * 400 | 0) + 384 | 0) >> 0] | 0)) break d;
     q = c[(w + (v * 400 | 0) + 292 | 0) >> 2] | 0;
    }
    Je(5601, f + 4848 | 0);
    fb();
   ...
   m = c[(f + 4032 | 0) >> 2] | 0;
   n = (c[(x + 1464 | 0) >> 2] | 0) + (m & 65535) | 0;
   o = c[(x + 1456 | 0) >> 2] | 0;
   if ((c[(f + 4032 | 0) >> 2] | 0) == (c[(o + (n * 400 | 0) | 0) >> 2] | 0) ? (c[(f + 4032 | 0) + 4 >> 2] | 0) == (c[(o + (n * 400 | 0) | 0) + 4 >> 2] | 0) : 0) {
    c[o + (n * 400 | 0) + 8 >> 2] = 3;
    c[o + (n * 400 | 0) + 12 >> 2] = c[(x + 1444 | 0) >> 2];
    break;
   } else {
    c[(f + 4856 | 0) >> 2] = m >>> 16;
    c[(f + 4856 | 0) + 4 >> 2] = m & 65535;
    Ie(4815, f + 4856 | 0);
    break;
   }
  } while (0);
  if ((M + 48 | 0 | 0) != (f + 4032 | 0 | 0)) {
   H = c[(f + 4032 | 0) + 4 >> 2] | 0;
   c[(M + 48 | 0) >> 2] = c[(f + 4032 | 0) >> 2];
   c[(M + 48 | 0) + 4 >> 2] = H;
  }
  c[(f + 8 | 0) >> 2] = -1;
  c[((f + 8 | 0) + 4 | 0) >> 2] = -1;
  ...
  a[((f + 8 | 0) + 188 | 0) >> 0] = a[((f + 8 | 0) + 188 | 0) >> 0] & -16 | 4;
  c[(f + 8 | 0) >> 2] = 2;
  c[((f + 8 | 0) + 4 | 0) >> 2] = -1;
  c[m >> 2] = 1048576;
  c[(f + 8 | 0) + 80 >> 2] = 0;
  ...
  a[((f + 8 | 0) + 8 | 0) >> 0] = 1;
  a[((f + 8 | 0) + 9 | 0) >> 0] = 1;
  b[(f + 8 | 0) + 10 + (a[s >> 0] << 1) >> 1] = 780;
  x = b[s >> 1] | 0;
  a[((f + 8 | 0) + 70 | 0) >> 0] = x & 255;
  a[((x & 255) << 24 >> 24) + ((f + 8 | 0) + 42) >> 0] = (x & 65535) >>> 8;
  a[((f + 8 | 0) + 75 | 0) >> 0] = (d[((f + 8 | 0) + 75 | 0) >> 0] | 0) + 16;
  a[s >> 0] = (a[s >> 0] | 0) + 1 << 24 >> 24;
  Bd(f + 4024 | 0, (c[5344] | 0) + 1168 | 0, f + 8 | 0);
  if ((M + 56 | 0 | 0) != (f + 4024 | 0 | 0)) {
   x = c[(f + 4024 | 0) + 4 >> 2] | 0;
   c[(M + 56 | 0) >> 2] = c[(f + 4024 | 0) >> 2];
   c[(M + 56 | 0) + 4 >> 2] = x;
  }
  Ue(f + 4768 | 0, 4769);
  c[(f + 4768 | 0) + 4 >> 2] = -2;
  ...
  a[((f + 4440 | 0) + 8 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 9 >> 0] = 13;
  a[((f + 4440 | 0) + 10 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 11 >> 0] = 13;
  a[((f + 4440 | 0) + 12 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 13 >> 0] = 13;
  a[((f + 4440 | 0) + 14 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 15 >> 0] = 13;
  a[((f + 4440 | 0) + 16 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 17 >> 0] = 13;
  a[((f + 4440 | 0) + 18 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 19 >> 0] = 13;
  a[((f + 4440 | 0) + 20 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 21 >> 0] = 13;
  a[((f + 4440 | 0) + 22 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 23 >> 0] = 13;
  a[((f + 4440 | 0) + 24 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 25 >> 0] = 13;
  a[((f + 4440 | 0) + 26 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 27 >> 0] = 13;
  a[((f + 4440 | 0) + 28 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 29 >> 0] = 13;
  a[((f + 4440 | 0) + 30 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 31 >> 0] = 13;
  a[((f + 4440 | 0) + 32 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 33 >> 0] = 13;
  a[(f + 4440 | 0) >> 0] = 0;
  a[(f + 4440 | 0) + 1 >> 0] = 1;
  q = (f + 4440 | 0) + 50 | 0;
  ...
  c[n >> 2] = o;
  c[(f + 952 | 0) + 60 >> 2] = c[(f + 4416 | 0) >> 2];
  m = o;
  if (o | 0) c[m >> 2] = (c[m >> 2] | 0) + 1;
  b[((f + 952 | 0) + 256 | 0) >> 1] = b[(f + 4440 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 258 | 0) >> 1] = b[((f + 4440 | 0) + 2 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 260 | 0) >> 1] = b[((f + 4440 | 0) + 4 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 262 | 0) >> 1] = b[((f + 4440 | 0) + 6 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 264 | 0) >> 1] = b[((f + 4440 | 0) + 8 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 266 | 0) >> 1] = b[((f + 4440 | 0) + 10 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 268 | 0) >> 1] = b[((f + 4440 | 0) + 12 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 270 | 0) >> 1] = b[((f + 4440 | 0) + 14 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 272 | 0) >> 1] = b[((f + 4440 | 0) + 16 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 274 | 0) >> 1] = b[((f + 4440 | 0) + 18 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 276 | 0) >> 1] = b[((f + 4440 | 0) + 20 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 278 | 0) >> 1] = b[((f + 4440 | 0) + 22 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 280 | 0) >> 1] = b[((f + 4440 | 0) + 24 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 282 | 0) >> 1] = b[((f + 4440 | 0) + 26 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 284 | 0) >> 1] = b[((f + 4440 | 0) + 28 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 286 | 0) >> 1] = b[((f + 4440 | 0) + 30 | 0) >> 1] | 0;
  b[((f + 952 | 0) + 288 | 0) >> 1] = b[((f + 4440 | 0) + 32 | 0) >> 1] | 0;
  B = b[r >> 1] | 0;
  a[((f + 952 | 0) + 290 | 0) >> 0] = B;
  a[((f + 952 | 0) + 291 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 36 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 292 | 0) >> 0] = B;
  a[((f + 952 | 0) + 293 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 38 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 294 | 0) >> 0] = B;
  a[((f + 952 | 0) + 295 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 40 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 296 | 0) >> 0] = B;
  a[((f + 952 | 0) + 297 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 42 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 298 | 0) >> 0] = B;
  a[((f + 952 | 0) + 299 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 44 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 300 | 0) >> 0] = B;
  a[((f + 952 | 0) + 301 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 46 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 302 | 0) >> 0] = B;
  a[((f + 952 | 0) + 303 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 48 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 304 | 0) >> 0] = B;
  a[((f + 952 | 0) + 305 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[q >> 1] | 0;
  a[((f + 952 | 0) + 306 | 0) >> 0] = B;
  a[((f + 952 | 0) + 307 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 52 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 308 | 0) >> 0] = B;
  a[((f + 952 | 0) + 309 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 54 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 310 | 0) >> 0] = B;
  a[((f + 952 | 0) + 311 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 56 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 312 | 0) >> 0] = B;
  a[((f + 952 | 0) + 313 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 58 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 314 | 0) >> 0] = B;
  a[((f + 952 | 0) + 315 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 60 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 316 | 0) >> 0] = B;
  a[((f + 952 | 0) + 317 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 62 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 318 | 0) >> 0] = B;
  a[((f + 952 | 0) + 319 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((f + 4440 | 0) + 64 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 320 | 0) >> 0] = B;
  a[((f + 952 | 0) + 321 | 0) >> 0] = (B & 65535) >>> 8;
  b[((f + 952 | 0) + 322 | 0) >> 1] = b[((f + 4440 | 0) + 66 | 0) >> 1] | 0;
  if (o | 0) {
   B = c[m >> 2] | 0;
   c[m >> 2] = B - 1;
   if ((B | 0) == 1) {
  ...
  E = b[r >> 1] | 0;
  a[((f + 952 | 0) + 290 | 0) >> 0] = E;
  a[((f + 952 | 0) + 291 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 36 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 292 | 0) >> 0] = E;
  a[((f + 952 | 0) + 293 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 38 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 294 | 0) >> 0] = E;
  a[((f + 952 | 0) + 295 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 40 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 296 | 0) >> 0] = E;
  a[((f + 952 | 0) + 297 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 42 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 298 | 0) >> 0] = E;
  a[((f + 952 | 0) + 299 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 44 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 300 | 0) >> 0] = E;
  a[((f + 952 | 0) + 301 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 46 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 302 | 0) >> 0] = E;
  a[((f + 952 | 0) + 303 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 48 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 304 | 0) >> 0] = E;
  a[((f + 952 | 0) + 305 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[q >> 1] | 0;
  a[((f + 952 | 0) + 306 | 0) >> 0] = E;
  a[((f + 952 | 0) + 307 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 52 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 308 | 0) >> 0] = E;
  a[((f + 952 | 0) + 309 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 54 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 310 | 0) >> 0] = E;
  a[((f + 952 | 0) + 311 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 56 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 312 | 0) >> 0] = E;
  a[((f + 952 | 0) + 313 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 58 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 314 | 0) >> 0] = E;
  a[((f + 952 | 0) + 315 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 60 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 316 | 0) >> 0] = E;
  a[((f + 952 | 0) + 317 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 62 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 318 | 0) >> 0] = E;
  a[((f + 952 | 0) + 319 | 0) >> 0] = (E & 65535) >>> 8;
  E = b[((f + 4440 | 0) + 64 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 320 | 0) >> 0] = E;
  a[((f + 952 | 0) + 321 | 0) >> 0] = (E & 65535) >>> 8;
  b[((f + 952 | 0) + 322 | 0) >> 1] = b[((f + 4440 | 0) + 66 | 0) >> 1] | 0;
  if (m | 0) {
   E = c[k >> 2] | 0;
   c[k >> 2] = E - 1;
  ...
  I = b[r >> 1] | 0;
  a[((f + 952 | 0) + 290 | 0) >> 0] = I;
  a[((f + 952 | 0) + 291 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 36 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 292 | 0) >> 0] = I;
  a[((f + 952 | 0) + 293 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 38 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 294 | 0) >> 0] = I;
  a[((f + 952 | 0) + 295 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 40 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 296 | 0) >> 0] = I;
  a[((f + 952 | 0) + 297 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 42 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 298 | 0) >> 0] = I;
  a[((f + 952 | 0) + 299 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 44 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 300 | 0) >> 0] = I;
  a[((f + 952 | 0) + 301 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 46 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 302 | 0) >> 0] = I;
  a[((f + 952 | 0) + 303 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 48 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 304 | 0) >> 0] = I;
  a[((f + 952 | 0) + 305 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[q >> 1] | 0;
  a[((f + 952 | 0) + 306 | 0) >> 0] = I;
  a[((f + 952 | 0) + 307 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 52 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 308 | 0) >> 0] = I;
  a[((f + 952 | 0) + 309 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 54 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 310 | 0) >> 0] = I;
  a[((f + 952 | 0) + 311 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 56 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 312 | 0) >> 0] = I;
  a[((f + 952 | 0) + 313 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 58 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 314 | 0) >> 0] = I;
  a[((f + 952 | 0) + 315 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 60 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 316 | 0) >> 0] = I;
  a[((f + 952 | 0) + 317 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 62 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 318 | 0) >> 0] = I;
  a[((f + 952 | 0) + 319 | 0) >> 0] = (I & 65535) >>> 8;
  I = b[((f + 4440 | 0) + 64 | 0) >> 1] | 0;
  a[((f + 952 | 0) + 320 | 0) >> 0] = I;
  a[((f + 952 | 0) + 321 | 0) >> 0] = (I & 65535) >>> 8;
  b[((f + 952 | 0) + 322 | 0) >> 1] = b[((f + 4440 | 0) + 66 | 0) >> 1] | 0;
  if (k | 0) {
   I = c[h >> 2] | 0;
   c[h >> 2] = I - 1;
  ...
  a[(f + 4040 | 0) + 200 >> 0] = 10;
  c[(f + 4040 | 0) + 204 >> 2] = 1;
  c[(f + 4040 | 0) >> 2] = 1254626822;
  c[(f + 4040 | 0) + 4 >> 2] = 1855796075;
  Ue(f + 4864 | 0, 4776);
  kd(f + 4040 | 0, f + 4864 | 0, 6);
  Ue(f + 4e3 | 0, 10172);
  Id(f + 952 | 0, f + 4e3 | 0, f + 4040 | 0);
  Cd(f, (c[5344] | 0) + 1168 | 0, f + 952 | 0);
  c[(f + 952 | 0) + 3028 >> 2] = 0;
  c[(f + 952 | 0) + 3016 >> 2] = 0;
  c[(f + 952 | 0) + 3004 >> 2] = 0;
  c[(f + 952 | 0) + 2992 >> 2] = 0;
  ...
  c[(f + 952 | 0) >> 2] = 0;
  c[(f + 4768 | 0) >> 2] = 0;
  Ve(f + 4440 | 0, f + 4768 | 0);
  c[(f + 4440 | 0) + 4 >> 2] = -1;
  c[((f + 4440 | 0) + 8 | 0) >> 2] = 0;
  c[((f + 4440 | 0) + 8 | 0) + 4 >> 2] = 0;
  c[((f + 4440 | 0) + 8 | 0) >> 2] = 2013282306;
  b[((f + 4440 | 0) + 8 | 0) + 4 >> 1] = 192;
  g[(f + 4440 | 0) + 16 >> 2] = 1.0;
  g[(f + 4440 | 0) + 20 >> 2] = 1.0;
  g[(f + 4440 | 0) + 24 >> 2] = 1.0;
  g[(f + 4440 | 0) + 28 >> 2] = 1.0;
  b[(f + 4440 | 0) + 32 >> 1] = 28672;
  b[(f + 4440 | 0) + 34 >> 1] = 28672;
  I = (f + 4440 | 0) + 36 | 0;
  c[I >> 2] = 0;
  b[I >> 1] = 32647;
  b[I + 2 >> 1] = 255;
  b[((f + 4440 | 0) + 40 | 0) >> 1] = 296;
  a[(f + 4440 | 0) + 44 >> 0] = 17;
  a[(f + 4440 | 0) + 45 >> 0] = 13;
  a[((f + 4440 | 0) + 46 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 47 >> 0] = 13;
  a[((f + 4440 | 0) + 48 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 49 >> 0] = 13;
  a[((f + 4440 | 0) + 50 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 51 >> 0] = 13;
  a[((f + 4440 | 0) + 52 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 53 >> 0] = 13;
  a[((f + 4440 | 0) + 54 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 55 >> 0] = 13;
  a[((f + 4440 | 0) + 56 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 57 >> 0] = 13;
  a[((f + 4440 | 0) + 58 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 59 >> 0] = 13;
  a[((f + 4440 | 0) + 60 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 61 >> 0] = 13;
  a[((f + 4440 | 0) + 62 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 63 >> 0] = 13;
  a[((f + 4440 | 0) + 64 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 65 >> 0] = 13;
  a[((f + 4440 | 0) + 66 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 67 >> 0] = 13;
  a[((f + 4440 | 0) + 68 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 69 >> 0] = 13;
  a[((f + 4440 | 0) + 70 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 71 >> 0] = 13;
  a[((f + 4440 | 0) + 72 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 73 >> 0] = 13;
  a[((f + 4440 | 0) + 74 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 75 >> 0] = 13;
  a[(f + 4440 | 0) + 42 >> 0] = 0;
  a[(f + 4440 | 0) + 43 >> 0] = 1;
  a[((f + 4440 | 0) + 108 | 0) >> 0] = 0;
  a[(f + 4440 | 0) + 109 >> 0] = 0;
  C = (f + 4440 | 0) + 92 | 0;
  B = (f + 4440 | 0) + 76 | 0;
  b[C >> 1] = 65535;
  ...
  a[(f + 4440 | 0) + 112 >> 0] = 17;
  a[(f + 4440 | 0) + 113 >> 0] = 13;
  a[((f + 4440 | 0) + 114 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 115 >> 0] = 13;
  a[((f + 4440 | 0) + 116 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 117 >> 0] = 13;
  a[((f + 4440 | 0) + 118 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 119 >> 0] = 13;
  a[((f + 4440 | 0) + 120 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 121 >> 0] = 13;
  a[((f + 4440 | 0) + 122 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 123 >> 0] = 13;
  a[((f + 4440 | 0) + 124 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 125 >> 0] = 13;
  a[((f + 4440 | 0) + 126 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 127 >> 0] = 13;
  a[((f + 4440 | 0) + 128 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 129 >> 0] = 13;
  a[((f + 4440 | 0) + 130 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 131 >> 0] = 13;
  a[((f + 4440 | 0) + 132 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 133 >> 0] = 13;
  a[((f + 4440 | 0) + 134 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 135 >> 0] = 13;
  a[((f + 4440 | 0) + 136 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 137 >> 0] = 13;
  a[((f + 4440 | 0) + 138 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 139 >> 0] = 13;
  a[((f + 4440 | 0) + 140 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 141 >> 0] = 13;
  a[((f + 4440 | 0) + 142 | 0) >> 0] = 17;
  a[(f + 4440 | 0) + 143 >> 0] = 13;
  a[(f + 4440 | 0) + 110 >> 0] = 0;
  a[(f + 4440 | 0) + 111 >> 0] = 1;
  a[((f + 4440 | 0) + 176 | 0) >> 0] = 0;
  a[(f + 4440 | 0) + 177 >> 0] = 0;
  F = (f + 4440 | 0) + 160 | 0;
  E = (f + 4440 | 0) + 144 | 0;
  b[F >> 1] = 65535;
  ...
  c[(f + 4440 | 0) + 316 >> 2] = 3;
  A = c[f + 4 >> 2] | 0;
  c[((f + 4440 | 0) + 320 | 0) >> 2] = c[f >> 2];
  c[((f + 4440 | 0) + 320 | 0) + 4 >> 2] = A;
  A = c[(f + 408 | 0) >> 2] | 0;
  b[(f + 4440 | 0) + 42 >> 1] = A;
  b[(f + 4440 | 0) + 44 >> 1] = A >>> 16;
  b[((f + 4440 | 0) + 46 | 0) >> 1] = b[((f + 408 | 0) + 4 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 48 | 0) >> 1] = b[((f + 408 | 0) + 6 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 50 | 0) >> 1] = b[((f + 408 | 0) + 8 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 52 | 0) >> 1] = b[((f + 408 | 0) + 10 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 54 | 0) >> 1] = b[((f + 408 | 0) + 12 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 56 | 0) >> 1] = b[((f + 408 | 0) + 14 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 58 | 0) >> 1] = b[((f + 408 | 0) + 16 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 60 | 0) >> 1] = b[((f + 408 | 0) + 18 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 62 | 0) >> 1] = b[((f + 408 | 0) + 20 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 64 | 0) >> 1] = b[((f + 408 | 0) + 22 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 66 | 0) >> 1] = b[((f + 408 | 0) + 24 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 68 | 0) >> 1] = b[((f + 408 | 0) + 26 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 70 | 0) >> 1] = b[((f + 408 | 0) + 28 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 72 | 0) >> 1] = b[((f + 408 | 0) + 30 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 74 | 0) >> 1] = b[((f + 408 | 0) + 32 | 0) >> 1] | 0;
  L = b[L >> 1] | 0;
  a[B >> 0] = L;
  a[(f + 4440 | 0) + 77 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 36 >> 1] | 0;
  a[(f + 4440 | 0) + 78 >> 0] = L;
  a[(f + 4440 | 0) + 79 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 38 >> 1] | 0;
  a[(f + 4440 | 0) + 80 >> 0] = L;
  a[(f + 4440 | 0) + 81 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 40 >> 1] | 0;
  a[(f + 4440 | 0) + 82 >> 0] = L;
  a[(f + 4440 | 0) + 83 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 42 >> 1] | 0;
  a[(f + 4440 | 0) + 84 >> 0] = L;
  a[(f + 4440 | 0) + 85 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 44 >> 1] | 0;
  a[(f + 4440 | 0) + 86 >> 0] = L;
  a[(f + 4440 | 0) + 87 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 46 >> 1] | 0;
  a[(f + 4440 | 0) + 88 >> 0] = L;
  a[(f + 4440 | 0) + 89 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 48 >> 1] | 0;
  a[(f + 4440 | 0) + 90 >> 0] = L;
  a[(f + 4440 | 0) + 91 >> 0] = (L & 65535) >>> 8;
  L = b[K >> 1] | 0;
  a[C >> 0] = L;
  a[(f + 4440 | 0) + 93 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 52 >> 1] | 0;
  a[(f + 4440 | 0) + 94 >> 0] = L;
  a[(f + 4440 | 0) + 95 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 54 >> 1] | 0;
  a[(f + 4440 | 0) + 96 >> 0] = L;
  a[(f + 4440 | 0) + 97 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 56 >> 1] | 0;
  a[(f + 4440 | 0) + 98 >> 0] = L;
  a[(f + 4440 | 0) + 99 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 58 >> 1] | 0;
  a[(f + 4440 | 0) + 100 >> 0] = L;
  a[(f + 4440 | 0) + 101 >> 0] = (L & 65535) >>> 8;
  L = b[((f + 408 | 0) + 60 | 0) >> 1] | 0;
  a[(f + 4440 | 0) + 102 >> 0] = L;
  a[(f + 4440 | 0) + 103 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 62 >> 1] | 0;
  a[(f + 4440 | 0) + 104 >> 0] = L;
  a[(f + 4440 | 0) + 105 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 408 | 0) + 64 >> 1] | 0;
  a[(f + 4440 | 0) + 106 >> 0] = L;
  a[(f + 4440 | 0) + 107 >> 0] = (L & 65535) >>> 8;
  b[((f + 4440 | 0) + 108 | 0) >> 1] = b[J >> 1] | 0;
  L = c[((f + 8 | 0) + 8 | 0) >> 2] | 0;
  b[(f + 4440 | 0) + 110 >> 1] = L;
  b[(f + 4440 | 0) + 112 >> 1] = L >>> 16;
  b[((f + 4440 | 0) + 114 | 0) >> 1] = b[((f + 8 | 0) + 12 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 116 | 0) >> 1] = b[((f + 8 | 0) + 14 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 118 | 0) >> 1] = b[((f + 8 | 0) + 16 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 120 | 0) >> 1] = b[((f + 8 | 0) + 18 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 122 | 0) >> 1] = b[((f + 8 | 0) + 20 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 124 | 0) >> 1] = b[((f + 8 | 0) + 22 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 126 | 0) >> 1] = b[((f + 8 | 0) + 24 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 128 | 0) >> 1] = b[((f + 8 | 0) + 26 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 130 | 0) >> 1] = b[((f + 8 | 0) + 28 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 132 | 0) >> 1] = b[((f + 8 | 0) + 30 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 134 | 0) >> 1] = b[((f + 8 | 0) + 32 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 136 | 0) >> 1] = b[((f + 8 | 0) + 34 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 138 | 0) >> 1] = b[((f + 8 | 0) + 36 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 140 | 0) >> 1] = b[((f + 8 | 0) + 38 | 0) >> 1] | 0;
  b[((f + 4440 | 0) + 142 | 0) >> 1] = b[((f + 8 | 0) + 40 | 0) >> 1] | 0;
  L = b[u >> 1] | 0;
  a[E >> 0] = L;
  a[(f + 4440 | 0) + 145 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 44 >> 1] | 0;
  a[(f + 4440 | 0) + 146 >> 0] = L;
  a[(f + 4440 | 0) + 147 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 46 >> 1] | 0;
  a[(f + 4440 | 0) + 148 >> 0] = L;
  a[(f + 4440 | 0) + 149 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 48 >> 1] | 0;
  a[(f + 4440 | 0) + 150 >> 0] = L;
  a[(f + 4440 | 0) + 151 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 50 >> 1] | 0;
  a[(f + 4440 | 0) + 152 >> 0] = L;
  a[(f + 4440 | 0) + 153 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 52 >> 1] | 0;
  a[(f + 4440 | 0) + 154 >> 0] = L;
  a[(f + 4440 | 0) + 155 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 54 >> 1] | 0;
  a[(f + 4440 | 0) + 156 >> 0] = L;
  a[(f + 4440 | 0) + 157 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 56 >> 1] | 0;
  a[(f + 4440 | 0) + 158 >> 0] = L;
  a[(f + 4440 | 0) + 159 >> 0] = (L & 65535) >>> 8;
  L = b[t >> 1] | 0;
  a[F >> 0] = L;
  a[(f + 4440 | 0) + 161 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 60 >> 1] | 0;
  a[(f + 4440 | 0) + 162 >> 0] = L;
  a[(f + 4440 | 0) + 163 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 62 >> 1] | 0;
  a[(f + 4440 | 0) + 164 >> 0] = L;
  a[(f + 4440 | 0) + 165 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 64 >> 1] | 0;
  a[(f + 4440 | 0) + 166 >> 0] = L;
  a[(f + 4440 | 0) + 167 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 66 >> 1] | 0;
  a[(f + 4440 | 0) + 168 >> 0] = L;
  a[(f + 4440 | 0) + 169 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 68 >> 1] | 0;
  a[(f + 4440 | 0) + 170 >> 0] = L;
  a[(f + 4440 | 0) + 171 >> 0] = (L & 65535) >>> 8;
  L = b[((f + 8 | 0) + 70 | 0) >> 1] | 0;
  a[(f + 4440 | 0) + 172 >> 0] = L;
  a[(f + 4440 | 0) + 173 >> 0] = (L & 65535) >>> 8;
  L = b[(f + 8 | 0) + 72 >> 1] | 0;
  a[(f + 4440 | 0) + 174 >> 0] = L;
  a[(f + 4440 | 0) + 175 >> 0] = (L & 65535) >>> 8;
  b[((f + 4440 | 0) + 176 | 0) >> 1] = b[s >> 1] | 0;
  b[((f + 4440 | 0) + 40 | 0) >> 1] = b[((f + 4440 | 0) + 40 | 0) >> 1] | 1;
  b[I >> 1] = b[I >> 1] & -64 | 35;
  Dd(f + 944 | 0, (c[5344] | 0) + 1168 | 0, f + 4440 | 0);
  if ((M + 40 | 0 | 0) != (f + 944 | 0 | 0)) {
   L = c[(f + 944 | 0) + 4 >> 2] | 0;
   c[(M + 40 | 0) >> 2] = c[(f + 944 | 0) >> 2];
   c[(M + 40 | 0) + 4 >> 2] = L;
  }
  h = c[5344] | 0;
  g[M + 272 >> 2] = +(c[h + 296 >> 2] | 0) * 2.4142134189605713 / +(c[h + 292 >> 2] | 0);
  c[(M + 276 | 0) >> 2] = 0;
  c[(M + 276 | 0) + 4 >> 2] = 0;
  c[(M + 276 | 0) + 8 >> 2] = 0;
  c[(M + 276 | 0) + 12 >> 2] = 0;
  g[M + 292 >> 2] = 2.4142134189605713;
  c[(M + 296 | 0) >> 2] = 0;
  c[(M + 296 | 0) + 4 >> 2] = 0;
  c[(M + 296 | 0) + 8 >> 2] = 0;
  c[(M + 296 | 0) + 12 >> 2] = 0;
  g[M + 312 >> 2] = -1.0002000331878662;
  g[M + 316 >> 2] = -1.0;
  c[(M + 320 | 0) >> 2] = 0;
  c[(M + 320 | 0) + 4 >> 2] = 0;
  g[M + 328 >> 2] = -.020002000033855438;
  g[M + 332 >> 2] = 0.0;
  h = c[((f + 200 | 0) + 200 | 0) >> 2] | 0;
  if (h | 0) wf(h);
  h = c[((f + 408 | 0) + 496 | 0) >> 2] | 0;
  if (h | 0) wf(h);
  c[((f + 408 | 0) + 496 | 0) >> 2] = 0;
  c[((f + 408 | 0) + 488 | 0) >> 2] = 0;
  c[((f + 408 | 0) + 492 | 0) >> 2] = 0;
   ...
   case 1:
    {
     ...
     if ((a[(ma + 256 | 0) >> 0] | 0) != -1) Wd(ma, ka, la);
     if ((a[(ma + 253 | 0) >> 0] | 0) != -1) Ie(6370, e + 200 | 0);
     if ((a[(ma + 252 | 0) >> 0] | 0) != -1) Ie(6434, e + 208 | 0);
     if ((ia | 0) > 0) {
      k = ($(ia, ia) | 0) << 1;
      h = f;
      o = 0;
   ...
   case 2:
    {
     ...
     if ((O | 0) >= 0) {
      ...
      while (1) {
       r = +(M | 0);
       z = +yf(r * 3.1415927410125732 / +(O | 0));
       I = +xf(r * 3.1415927410125732 / +(O | 0));
       if ((Q | 0) >= 0) {
        x = 1.0 / +(O | 0) * r;
        ...
        while (1) {
         w = +(m | 0);
         u = +yf(w * 6.2831854820251465 / +(Q | 0));
         v = z * +xf(w * 6.2831854820251465 / +(Q | 0));
     ...
     if ((a[(ma + 256 | 0) >> 0] | 0) != -1) Wd(ma, ka, la);
     if ((a[(ma + 253 | 0) >> 0] | 0) != -1) Ie(6497, e + 216 | 0);
     if ((a[(ma + 252 | 0) >> 0] | 0) != -1) Ie(6564, e + 224 | 0);
     if ((Q | 0) > 0) {
      i = la + 1 + Q | 0;
      j = c[(ma + 512 | 0) >> 2] | 0;
      h = f;
   ...
   case 3:
    {
      ...
      if (L) {
       ...
       while (1) {
        ...
        if (k << 24 >> 24 == 2) {
         ...
         Xd(j, k, u + ea * .5 * x + (I + R), v + ea * .5 * y + (J + S), w + ea * .5 * z + (N + T), 0.0) | 0;
         i = a[(ma + 263 | 0) >> 0] | 0;
         h = c[(ma + 508 | 0) >> 2] | 0;
        }
        ia = a[(ma + 247 | 0) >> 0] | 0;
        ...
        if (i << 24 >> 24 == 2) {
         ...
         g[h + 4 >> 2] = v + y + (J + S * 0.0);
         g[h + 8 >> 2] = w + z + (N + T * 0.0);
        } else Xd(h, i, u + x + (I + R * 0.0), v + y + (J + S * 0.0), w + z + (N + T * 0.0), 0.0) | 0;
       ...
       while (1) {
        ...
        } else Xd(i, j, u + ea * .5 * x + (I + R), v + ea * .5 * y + (J + S), w + ea * .5 * z + (N + T), 0.0) | 0;
     ...
     do if ((O | 0) >= 0) {
      ...
      while (1) {
       ...
       } else Xd(i, j, R * 0.0 - V + (Y * 0.0 + aa * 0.0), S * 0.0 - W + (Z * 0.0 + ba * 0.0), T * 0.0 - X + (_ * 0.0 + ca * 0.0), 0.0) | 0;
       if ((m | 0) == (O | 0)) break;
       h = h + 1 | 0;
       r = +g[o >> 2];
       v = +g[B >> 2];
     ...
     if ((a[(ma + 256 | 0) >> 0] | 0) != -1) Wd(ma, ka, la);
     if ((a[(ma + 253 | 0) >> 0] | 0) != -1) Ie(6630, e + 232 | 0);
     if ((a[(ma + 252 | 0) >> 0] | 0) != -1) Ie(6699, e + 240 | 0);
     if ((a[(ma + 248 | 0) >> 0] | 0) != -1) Ie(6767, e + 248 | 0);
     if ((O | 0) > 0) {
      i = la + 1 + O | 0;
      j = c[(ma + 512 | 0) >> 2] | 0;
      h = f;
   ...
   case 4:
    {
     ...
     if ((a[(ma + 256 | 0) >> 0] | 0) != -1) Wd(ma, ka, la);
     if ((a[(ma + 253 | 0) >> 0] | 0) != -1) Ie(6835, e + 256 | 0);
     if ((a[(ma + 252 | 0) >> 0] | 0) != -1) Ie(6901, e + 264 | 0);
     if ((a[(ma + 248 | 0) >> 0] | 0) != -1) Ie(6966, e + 272 | 0);
     m = c[5358] | 0;
     if ((m | 0) <= 0) {
      c[e + 7016 >> 2] = 2;
      c[e + 7020 >> 2] = 15;
   ...
   case 5:
    {
     ...
     if ((a[(ma + 256 | 0) >> 0] | 0) != -1) Wd(ma, ka, la);
     if ((a[(ma + 253 | 0) >> 0] | 0) != -1) Ie(7031, e + 280 | 0);
     if ((a[(ma + 252 | 0) >> 0] | 0) != -1) Ie(7097, e + 288 | 0);
     if ((U | 0) > 0) {
      l = 0;
      while (1) {
       i = ($(l, U + 1 | 0) | 0) + la | 0;
   ...
   case 2:
    {
     ...
     if ((j | 0) == (c[(i + (f * 3712 | 0) | 0) >> 2] | 0) ? (k | 0) == (c[(i + (f * 3712 | 0) | 0) + 4 >> 2] | 0) : 0) if ((c[i + (f * 3712 | 0) + 8 >> 2] | 0) == 3) {
      ...
      if ((j | 0) == (c[w >> 2] | 0) ? (k | 0) == (c[w + 4 >> 2] | 0) : 0) if ((c[i + ((h + (j & 65535) | 0) * 3712 | 0) + 8 >> 2] | 0) == 3) {
       ...
       Vf(i + ((h + (j & 65535) | 0) * 3712 | 0) + 3068 | 0, -1, 640) | 0;
       Ld(i + ((h + (j & 65535) | 0) * 3712 | 0) | 0);
       k = z;
       m = c[z >> 2] | 0;
       h = c[(A + 360 | 0) >> 2] | 0;
       i = c[(A + 352 | 0) >> 2] | 0;
...
function pd(e) {
 ...
 if ((j | 0) > 0) {
  ...
  do {
   ...
   a[x + (f * 776 | 0) + 89 >> 0] = 3;
   c[(e + 4768 | 0) >> 2] = 0;
   Ve(x + (f * 776 | 0) + 92 | 0, e + 4768 | 0);
   c[x + (f * 776 | 0) + 96 >> 2] = -1;
   w = x + (f * 776 | 0) + 104 | 0;
   c[w >> 2] = -1;
   c[w + 4 >> 2] = -1;
   w = x + (f * 776 | 0) + 696 | 0;
   Vf(x + (f * 776 | 0) + 112 | 0, 0, 584) | 0;
   a[w >> 0] = a[w >> 0] & -128;
   c[x + (f * 776 | 0) + 704 >> 2] = 0;
   c[x + (f * 776 | 0) + 708 >> 2] = -2;
   c[x + (f * 776 | 0) + 712 >> 2] = -1;
 ...
 a[p + 1436 >> 0] = 1;
 f = c[5364] | 0;
 c[((e + 4440 | 0) + 16 | 0) >> 2] = e + 4440 | 0;
 c[(e + 4440 | 0) >> 2] = 1252;
 c[(e + 4440 | 0) + 4 >> 2] = p + 1168 | 0;
 c[p + 1696 >> 2] = Se(f, e + 4440 | 0) | 0;
 f = c[((e + 4440 | 0) + 16 | 0) >> 2] | 0;
 do if ((f | 0) == (e + 4440 | 0 | 0)) Gc[c[(c[f >> 2] | 0) + 16 >> 2] & 127](f); else {
  if (!f) break;
  Gc[c[(c[f >> 2] | 0) + 20 >> 2] & 127](f);
 } while (0);
 o = c[((e + 4920 | 0) + 68 | 0) >> 2] | 0;
 f = (c[(p + 1180 | 0) >> 2] | 0) - (c[(p + 1176 | 0) >> 2] | 0) | 0;
 h = f + (c[((e + 4920 | 0) + 64 | 0) >> 2] | 0) | 0;
 ...
 f = c[5363] | 0;
 c[((e + 4e3 | 0) + 16 | 0) >> 2] = e + 4e3 | 0;
 c[(e + 4e3 | 0) >> 2] = 1216;
 f = Se(f, e + 4e3 | 0) | 0;
 c[(c[5344] | 0) + 156 >> 2] = f;
 f = c[((e + 4e3 | 0) + 16 | 0) >> 2] | 0;
 do if ((f | 0) == (e + 4e3 | 0 | 0)) Gc[c[(c[f >> 2] | 0) + 16 >> 2] & 127](f); else {
  if (!f) break;
  Gc[c[(c[f >> 2] | 0) + 20 >> 2] & 127](f);
 } while (0);
 w = (c[5344] | 0) + 116 | 0;
 ...
 Vf(f + 716 | 0 | 0, 0, 141) | 0;
 Vf(f + 860 | 0 | 0, 0, 141) | 0;
 Vf(f + 1004 | 0 | 0, 0, 141) | 0;
 Vf(f + 1148 | 0 | 0, 0, 149) | 0;
 c[(f + 1368 | 0) >> 2] = 16;
 c[f + 1372 >> 2] = 65536;
 a[f + 1376 >> 0] = 0;
 a[(f + 1380 | 0) >> 0] = 0;
 ...
 c[f + 1592 >> 2] = 2;
 a[f + 1408 >> 0] = 1;
 a[(f + 1409 | 0) >> 0] = a[(e + 5036 | 0) >> 0] | 0;
 a[(f + 1409 | 0) + 1 >> 0] = a[(e + 5036 | 0) + 1 >> 0] | 0;
 a[(f + 1409 | 0) + 2 >> 0] = a[(e + 5036 | 0) + 2 >> 0] | 0;
 a[(f + 1409 | 0) + 3 >> 0] = a[(e + 5036 | 0) + 3 >> 0] | 0;
 a[(f + 1409 | 0) + 4 >> 0] = a[(e + 5036 | 0) + 4 >> 0] | 0;
 a[(f + 1409 | 0) + 5 >> 0] = a[(e + 5036 | 0) + 5 >> 0] | 0;
 Vf(f + 2136 | 0, 0, 1024) | 0;
 c[f + 2168 >> 2] = 54;
 c[f + 2172 >> 2] = 53;
 c[f + 2188 >> 2] = 52;
 c[f + 2200 >> 2] = 112;
 ...
 ya(18387, f | 0, 1, 58) | 0;
 ac(18387, f | 0, 1, 58) | 0;
 if (a[f + 1413 >> 0] | 0) sb(f | 0, 1, 59) | 0;
 if (a[f + 1414 >> 0] | 0) Eb(f | 0, 1, 60) | 0;
 F = c[5364] | 0;
 c[((e + 4768 | 0) + 16 | 0) >> 2] = e + 4768 | 0;
 c[(e + 4768 | 0) >> 2] = 1580;
 c[(e + 4768 | 0) + 4 >> 2] = f;
 c[(f + 2128 | 0) >> 2] = Se(F, e + 4768 | 0) | 0;
 f = c[((e + 4768 | 0) + 16 | 0) >> 2] | 0;
 do if ((f | 0) == (e + 4768 | 0 | 0)) Gc[c[(c[f >> 2] | 0) + 16 >> 2] & 127](f); else {
  if (!f) break;
  Gc[c[(c[f >> 2] | 0) + 20 >> 2] & 127](f);
 } while (0);
 if (!(a[22049] | 0)) {
 ...
 c[u + 24 >> 2] = 0;
 c[u + 28 >> 2] = 0;
 g[((e + 408 | 0) + 80 | 0) >> 2] = 1.0;
 h = (e + 408 | 0) + 84 | 0;
 c[h >> 2] = 0;
 c[h + 4 >> 2] = 0;
 c[h + 8 >> 2] = 0;
 c[h + 12 >> 2] = 0;
 g[((e + 408 | 0) + 100 | 0) >> 2] = 1.0;
 i = (e + 408 | 0) + 104 | 0;
 c[i >> 2] = 0;
 c[i + 4 >> 2] = 0;
 c[i + 8 >> 2] = 0;
 c[i + 12 >> 2] = 0;
 g[((e + 408 | 0) + 120 | 0) >> 2] = 1.0;
 j = (e + 408 | 0) + 124 | 0;
 c[j >> 2] = 0;
 c[j + 4 >> 2] = 0;
 c[j + 8 >> 2] = 0;
 c[j + 12 >> 2] = 0;
 g[((e + 408 | 0) + 140 | 0) >> 2] = 1.0;
 g[(e + 408 | 0) + 144 >> 2] = 1.0;
 g[(e + 408 | 0) + 148 >> 2] = 1.0;
 g[(e + 408 | 0) + 152 >> 2] = 1.0;
 g[(e + 408 | 0) + 156 >> 2] = 1.0;
 ...
 c[q + 8 >> 2] = 0;
 c[q + 12 >> 2] = 0;
 c[((e + 408 | 0) + 176 | 0) >> 2] = 16;
 c[((e + 408 | 0) + 180 | 0) >> 2] = 65536;
 c[(e + 408 | 0) + 184 >> 2] = 0;
 c[(e + 408 | 0) + 188 >> 2] = 0;
 c[(e + 408 | 0) + 192 >> 2] = 1;
 a[(e + 408 | 0) + 198 >> 0] = 17;
 ...
 c[v + 8 >> 2] = 0;
 c[v + 12 >> 2] = 0;
 c[((e + 408 | 0) + 280 | 0) >> 2] = 16;
 c[((e + 408 | 0) + 284 | 0) >> 2] = 65536;
 c[(e + 408 | 0) + 288 >> 2] = 0;
 c[(e + 408 | 0) + 292 >> 2] = 0;
 c[(e + 408 | 0) + 296 >> 2] = -1;
 c[(e + 408 | 0) + 300 >> 2] = -1;
 ...
 b[w + 14 >> 1] = 0;
 c[((e + 408 | 0) + 372 | 0) >> 2] = 0;
 c[((e + 408 | 0) + 372 | 0) + 4 >> 2] = 0;
 c[((e + 408 | 0) + 372 | 0) + 8 >> 2] = 0;
 a[((e + 408 | 0) + 372 | 0) + 12 >> 0] = 0;
 c[(e + 4768 | 0) >> 2] = 0;
 Ve((e + 408 | 0) + 388 | 0, e + 4768 | 0);
 c[(e + 408 | 0) + 392 >> 2] = -1;
 c[((e + 408 | 0) + 400 | 0) >> 2] = -1;
 c[((e + 408 | 0) + 400 | 0) + 4 >> 2] = -1;
 c[(e + 408 | 0) + 408 >> 2] = 0;
 c[(e + 408 | 0) + 412 >> 2] = -1;
 w = (e + 408 | 0) + 416 | 0;
 x = w + 68 | 0;
 ...
 a[((e + 408 | 0) + 484 | 0) >> 0] = a[((e + 408 | 0) + 484 | 0) >> 0] & -16;
 c[((e + 408 | 0) + 488 | 0) >> 2] = 0;
 c[((e + 408 | 0) + 492 | 0) >> 2] = 0;
 c[((e + 408 | 0) + 496 | 0) >> 2] = 0;
 a[(e + 408 | 0) + 504 >> 0] = 0;
 ...
 c[(e + 408 | 0) + 516 >> 2] = 0;
 a[((e + 408 | 0) + 68 | 0) >> 0] = 1;
 b[(e + 408 | 0) + 2 + (a[r >> 0] << 1) >> 1] = 512;
 m = b[r >> 1] | 0;
 a[s >> 0] = m & 255;
 a[((m & 255) << 24 >> 24) + ((e + 408 | 0) + 34) >> 0] = (m & 65535) >>> 8;
 a[f >> 0] = (d[f >> 0] | 0) + 12;
 m = (a[r >> 0] | 0) + 1 << 24 >> 24;
 a[r >> 0] = m;
 b[(e + 408 | 0) + 2 + (m << 24 >> 24 << 1) >> 1] = 778;
 m = b[r >> 1] | 0;
 a[((e + 408 | 0) + 60 | 0) >> 0] = m & 255;
 a[((m & 255) << 24 >> 24) + ((e + 408 | 0) + 34) >> 0] = (m & 65535) >>> 8;
 a[f >> 0] = (d[f >> 0] | 0) + 16;
 a[r >> 0] = (a[r >> 0] | 0) + 1 << 24 >> 24;
 g[((e + 408 | 0) + 80 | 0) >> 2] = .9999999403953552;
 g[h >> 2] = 0.0;
 g[(e + 408 | 0) + 88 >> 2] = 0.0;
 g[(e + 408 | 0) + 92 >> 2] = 0.0;
 g[(e + 408 | 0) + 96 >> 2] = 0.0;
 g[((e + 408 | 0) + 100 | 0) >> 2] = -4.371138828673793e-08;
 g[i >> 2] = 1.0;
 g[(e + 408 | 0) + 108 >> 2] = 0.0;
 g[(e + 408 | 0) + 112 >> 2] = 0.0;
 g[(e + 408 | 0) + 116 >> 2] = -1.0;
 g[((e + 408 | 0) + 120 | 0) >> 2] = -4.371138828673793e-08;
 g[j >> 2] = 0.0;
 c[((e + 408 | 0) + 128 | 0) >> 2] = c[(e + 928 | 0) >> 2];
 c[((e + 408 | 0) + 128 | 0) + 4 >> 2] = c[(e + 928 | 0) + 4 >> 2];
 c[((e + 408 | 0) + 128 | 0) + 8 >> 2] = c[(e + 928 | 0) + 8 >> 2];
 g[((e + 408 | 0) + 140 | 0) >> 2] = 1.0;
 c[(e + 4768 | 0) >> 2] = c[((e + 408 | 0) + 84 | 0) >> 2];
 c[(e + 4768 | 0) + 4 >> 2] = c[((e + 408 | 0) + 84 | 0) + 4 >> 2];
 c[(e + 4768 | 0) + 8 >> 2] = c[((e + 408 | 0) + 84 | 0) + 8 >> 2];
 c[(e + 4768 | 0) + 12 >> 2] = c[((e + 408 | 0) + 84 | 0) + 12 >> 2];
 m = c[((e + 408 | 0) + 104 | 0) >> 2] | 0;
 n = c[((e + 408 | 0) + 104 | 0) + 4 >> 2] | 0;
 o = c[((e + 408 | 0) + 112 | 0) >> 2] | 0;
 p = c[((e + 408 | 0) + 112 | 0) + 4 >> 2] | 0;
 c[(e + 4440 | 0) >> 2] = c[((e + 408 | 0) + 124 | 0) >> 2];
 c[(e + 4440 | 0) + 4 >> 2] = c[((e + 408 | 0) + 124 | 0) + 4 >> 2];
 c[(e + 4440 | 0) + 8 >> 2] = c[((e + 408 | 0) + 124 | 0) + 8 >> 2];
 c[(e + 4440 | 0) + 12 >> 2] = c[((e + 408 | 0) + 124 | 0) + 12 >> 2];
 c[(e + 4424 | 0) >> 2] = c[((e + 408 | 0) + 144 | 0) >> 2];
 c[(e + 4424 | 0) + 4 >> 2] = c[((e + 408 | 0) + 144 | 0) + 4 >> 2];
 c[(e + 4424 | 0) + 8 >> 2] = c[((e + 408 | 0) + 144 | 0) + 8 >> 2];
 c[(e + 4424 | 0) + 12 >> 2] = c[((e + 408 | 0) + 144 | 0) + 12 >> 2];
 f = c[((e + 408 | 0) + 164 | 0) >> 2] | 0;
 h = c[((e + 408 | 0) + 172 | 0) >> 2] | 0;
 do if ((f | 0) == (h | 0)) {
  h = c[((e + 408 | 0) + 176 | 0) >> 2] | 0;
  if ((f >> 1 | 0) >= (h | 0)) {
   h = c[((e + 408 | 0) + 180 | 0) >> 2] | 0;
   h = (f >> 1 | 0) > (h | 0) ? h : f >> 1;
  }
  l = h + f | 0;
  if (!h) break;
  f = f - (c[((e + 408 | 0) + 168 | 0) >> 2] | 0) | 0;
  k = vf(l * 112 | 0) | 0;
  if ((f | 0) > 0) {
   h = k;
   i = 0;
   j = (c[q >> 2] | 0) + ((c[((e + 408 | 0) + 168 | 0) >> 2] | 0) * 112 | 0) | 0;
   while (1) {
    w = h;
    h = h + 112 | 0;
    y = j;
 ...
 c[((e + 408 | 0) + 172 | 0) >> 2] = f + 1;
 h = c[q >> 2] | 0;
 c[h + (f * 112 | 0) >> 2] = 2;
 c[h + (f * 112 | 0) + 4 >> 2] = 1065353215;
 F = h + (f * 112 | 0) + 8 | 0;
 c[F >> 2] = c[(e + 4768 | 0) >> 2];
 c[F + 4 >> 2] = c[(e + 4768 | 0) + 4 >> 2];
 c[F + 8 >> 2] = c[(e + 4768 | 0) + 8 >> 2];
 c[F + 12 >> 2] = c[(e + 4768 | 0) + 12 >> 2];
 c[h + (f * 112 | 0) + 24 >> 2] = -1287930578;
 F = h + (f * 112 | 0) + 28 | 0;
 c[F >> 2] = m;
 c[F + 4 >> 2] = n;
 m = h + (f * 112 | 0) + 36 | 0;
 c[m >> 2] = o;
 c[m + 4 >> 2] = p;
 c[h + (f * 112 | 0) + 44 >> 2] = -1287930578;
 m = h + (f * 112 | 0) + 48 | 0;
 c[m >> 2] = c[(e + 4440 | 0) >> 2];
 c[m + 4 >> 2] = c[(e + 4440 | 0) + 4 >> 2];
 c[m + 8 >> 2] = c[(e + 4440 | 0) + 8 >> 2];
 c[m + 12 >> 2] = c[(e + 4440 | 0) + 12 >> 2];
 c[h + (f * 112 | 0) + 64 >> 2] = 1065353216;
 g[h + (f * 112 | 0) + 68 >> 2] = .05000000074505806;
 m = h + (f * 112 | 0) + 72 | 0;
 c[m >> 2] = 0;
 c[m + 4 >> 2] = 0;
 c[h + (f * 112 | 0) + 80 >> 2] = 3;
 ...
 m = h + (f * 112 | 0) + 88 | 0;
 c[m >> 2] = c[(e + 4424 | 0) >> 2];
 c[m + 4 >> 2] = c[(e + 4424 | 0) + 4 >> 2];
 c[m + 8 >> 2] = c[(e + 4424 | 0) + 8 >> 2];
 c[m + 12 >> 2] = c[(e + 4424 | 0) + 12 >> 2];
 c[h + (f * 112 | 0) + 104 >> 2] = 12;
 c[h + (f * 112 | 0) + 108 >> 2] = 6;
 m = (c[((e + 408 | 0) + 76 | 0) >> 2] | 0) + 18 | 0;
 c[((e + 408 | 0) + 76 | 0) >> 2] = m;
 n = c[u >> 2] | 0;
 f = c[((e + 408 | 0) + 268 | 0) >> 2] | 0;
 h = c[((e + 408 | 0) + 276 | 0) >> 2] | 0;
 do if ((f | 0) == (h | 0)) {
  h = c[((e + 408 | 0) + 280 | 0) >> 2] | 0;
  if ((f >> 1 | 0) >= (h | 0)) {
   h = c[((e + 408 | 0) + 284 | 0) >> 2] | 0;
   h = (f >> 1 | 0) > (h | 0) ? h : f >> 1;
  }
  l = h + f | 0;
  if (!h) break;
  f = f - (c[((e + 408 | 0) + 272 | 0) >> 2] | 0) | 0;
  k = vf(l << 3) | 0;
  if ((f | 0) > 0) {
   h = k;
   i = 0;
   j = (c[v >> 2] | 0) + (c[((e + 408 | 0) + 272 | 0) >> 2] << 3) | 0;
   while (1) {
    D = j;
    E = c[D + 4 >> 2] | 0;
    F = h;
 ...
 c[((e + 408 | 0) + 276 | 0) >> 2] = f + 1;
 E = (c[v >> 2] | 0) + (f << 3) | 0;
 c[E >> 2] = n;
 c[E + 4 >> 2] = m;
 c[u >> 2] = (c[u >> 2] | 0) + (c[((e + 408 | 0) + 76 | 0) >> 2] | 0);
 c[((e + 408 | 0) + 76 | 0) >> 2] = 0;
 Vd(e + 200 | 0, e + 408 | 0);
 E = c[5344] | 0;
 F = c[((e + 200 | 0) + 200 | 0) >> 2] | 0;
 ve(e + 4032 | 0, E + 1192 | 0, (e + 200 | 0) + 92 | 0);
 c[e + 6984 >> 2] = r;
 c[e + 7e3 >> 2] = s;
 c[e + 7008 >> 2] = t;
 c[e + 7072 >> 2] = v;
    ...
    case 0:
     {
      ...
      if ((m | 0) == (c[(n + (h * 776 | 0) | 0) >> 2] | 0) ? (l | 0) == (c[(n + (h * 776 | 0) | 0) + 4 >> 2] | 0) : 0) if ((c[n + (h * 776 | 0) + 8 >> 2] | 0) == 3) if ((m | 0) == (c[(n + ((j + (m & 65535) | 0) * 776 | 0) | 0) >> 2] | 0) ? (l | 0) == (c[(n + ((j + (m & 65535) | 0) * 776 | 0) | 0) + 4 >> 2] | 0) : 0) if ((c[n + ((j + (m & 65535) | 0) * 776 | 0) + 8 >> 2] | 0) == 3) {
       ...
       if (c[(n + ((j + (m & 65535) | 0) * 776 | 0) + 752 | 0) >> 2] | 0) wb(1, n + ((j + (m & 65535) | 0) * 776 | 0) + 752 | 0 | 0);
       if (c[(n + ((j + (m & 65535) | 0) * 776 | 0) + 768 | 0) >> 2] | 0) Za(1, n + ((j + (m & 65535) | 0) * 776 | 0) + 768 | 0 | 0);
       if (c[(n + ((j + (m & 65535) | 0) * 776 | 0) + 772 | 0) >> 2] | 0) Za(1, n + ((j + (m & 65535) | 0) * 776 | 0) + 772 | 0 | 0);
       if (!(a[n + ((j + (m & 65535) | 0) * 776 | 0) + 746 >> 0] | 0)) if (c[(n + ((j + (m & 65535) | 0) * 776 | 0) + 756 | 0) >> 2] | 0) cc(1, n + ((j + (m & 65535) | 0) * 776 | 0) + 756 | 0 | 0);
       h = O + 720 | 0;
       l = h + 44 | 0;
       do {
        c[h >> 2] = 0;
       ...
       if ((O + 720 | 0 | 0) == (n + ((j + (m & 65535) | 0) * 776 | 0) + 704 | 0 | 0)) h = -2; else {
        ...
        Ve(n + ((j + (m & 65535) | 0) * 776 | 0) + 704 | 0, O + 720 | 0);
        h = c[((O + 720 | 0) + 4 | 0) >> 2] | 0;
       }
       ...
       if ((n + ((j + (m & 65535) | 0) * 776 | 0) + 16 | 0 | 0) == (O | 0)) {
        ...
        Ve(n + ((j + (m & 65535) | 0) * 776 | 0) + 92 | 0, O + 76 | 0);
        h = c[(O + 80 | 0) >> 2] | 0;
        I = c[(O + 88 | 0) + 4 >> 2] | 0;
            ...
            if (n) {
             ...
             if ((c[p + ((o + (q & 65535) | 0) * 400 | 0) + 8 >> 2] | 0) == 3) {
              ...
              if ((O | 0) == (p + ((o + (q & 65535) | 0) * 400 | 0) + 16 | 0 | 0)) h = c[(O + 96 | 0) >> 2] | 0; else {
               ...
               Ve(p + ((o + (q & 65535) | 0) * 400 | 0) + 108 | 0, O + 92 | 0);
               h = c[(O + 96 | 0) >> 2] | 0;
               N = c[(O + 104 | 0) + 4 >> 2] | 0;
...
function Yc(d) {
 d = d | 0;
 var e = 0, f = 0, h = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0, D = 0, E = 0, F = 0, G = 0, H = 0, I = 0, J = 0, K = 0, L = 0, M = 0, N = 0, O = 0, P = 0, Q = 0, R = 0, S = 0, T = 0, U = 0, V = 0, W = 0, X = 0, Y = 0;
 R = 0;
 Y = i;
 i = i + 11200 | 0;
 a : do if (!0) {
 ...
 c[(Y + 4920 | 0) >> 2] = 640;
 c[((Y + 4920 | 0) + 4 | 0) >> 2] = 400;
 c[((Y + 4920 | 0) + 8 | 0) >> 2] = 0;
 c[((Y + 4920 | 0) + 12 | 0) >> 2] = 12;
 c[((Y + 4920 | 0) + 16 | 0) >> 2] = 1;
 a[((Y + 4920 | 0) + 20 | 0) >> 0] = 1;
 c[((Y + 4920 | 0) + 24 | 0) >> 2] = 1;
 Q = (Y + 4920 | 0) + 28 | 0;
 ...
 if ((m | 0) > 0) {
  ...
  O = c[Q >> 2] | 0;
  c[O + 4 >> 2] = m;
  c[((Y + 4920 | 0) + 32 | 0) >> 2] = O + 8 | 0;
  Tf(O + 8 | 0 | 0, 4952, m | 0) | 0;
  a[(c[((Y + 4920 | 0) + 32 | 0) >> 2] | 0) + m >> 0] = 0;
  O = Q;
  m = c[Q >> 2] | 0;
 } else {
  c[Q >> 2] = 0;
 ...
 a[(Y + 4920 | 0) + 57 >> 0] = 3;
 a[(Y + 4920 | 0) + 60 >> 0] = 0;
 c[((Y + 4920 | 0) + 64 | 0) >> 2] = 256;
 c[((Y + 4920 | 0) + 68 | 0) >> 2] = 256;
 c[(Y + 4920 | 0) + 72 >> 2] = 4194304;
 c[(Y + 4920 | 0) + 76 >> 2] = 65536;
 c[(Y + 4920 | 0) + 80 >> 2] = 4096;
 c[((Y + 4920 | 0) + 84 | 0) >> 2] = 128;
 c[(Y + 4920 | 0) + 100 >> 2] = 0;
 c[((Y + 4920 | 0) + 88 | 0) >> 2] = 128;
 c[(Y + 4920 | 0) + 104 >> 2] = 0;
 c[((Y + 4920 | 0) + 92 | 0) >> 2] = 128;
 c[(Y + 4920 | 0) + 108 >> 2] = 0;
 c[((Y + 4920 | 0) + 96 | 0) >> 2] = 128;
 c[(Y + 4920 | 0) + 112 >> 2] = 0;
 c[(Y + 4920 | 0) >> 2] = 800;
 c[((Y + 4920 | 0) + 4 | 0) >> 2] = 500;
 a[((Y + 4920 | 0) + 20 | 0) >> 0] = 1;
 if (m | 0) {
  N = c[m >> 2] | 0;
  c[m >> 2] = N - 1;
 ...
 c[5344] = n;
 c[n >> 2] = c[(Y + 4920 | 0) >> 2];
 c[n + 4 >> 2] = c[(Y + 4920 | 0) + 4 >> 2];
 c[n + 8 >> 2] = c[(Y + 4920 | 0) + 8 >> 2];
 c[n + 12 >> 2] = c[(Y + 4920 | 0) + 12 >> 2];
 c[n + 16 >> 2] = c[(Y + 4920 | 0) + 16 >> 2];
 c[n + 20 >> 2] = c[(Y + 4920 | 0) + 20 >> 2];
 c[n + 24 >> 2] = c[(Y + 4920 | 0) + 24 >> 2];
 if ((n + 28 | 0 | 0) != (Q | 0)) {
  m = c[(n + 28 | 0) >> 2] | 0;
  if (m | 0) {
   D = c[m >> 2] | 0;
 ...
 D = c[5344] | 0;
 a[D + 388 >> 0] = 1;
 c[(D + 160 | 0) >> 2] = c[(Y + 4920 | 0) >> 2];
 c[(D + 160 | 0) + 4 >> 2] = c[(Y + 4920 | 0) + 4 >> 2];
 c[(D + 160 | 0) + 8 >> 2] = c[(Y + 4920 | 0) + 8 >> 2];
 c[(D + 160 | 0) + 12 >> 2] = c[(Y + 4920 | 0) + 12 >> 2];
 c[(D + 160 | 0) + 16 >> 2] = c[(Y + 4920 | 0) + 16 >> 2];
 c[(D + 160 | 0) + 20 >> 2] = c[(Y + 4920 | 0) + 20 >> 2];
 c[(D + 160 | 0) + 24 >> 2] = c[(Y + 4920 | 0) + 24 >> 2];
 if ((D + 188 | 0 | 0) != (Q | 0)) {
  m = c[(D + 188 | 0) >> 2] | 0;
  if (m | 0) {
   r = c[m >> 2] | 0;
 ...
 r = c[(Y + 4920 | 0) >> 2] | 0;
 c[(Y + 4864 | 0) >> 2] = r;
 m = c[((Y + 4920 | 0) + 4 | 0) >> 2] | 0;
 c[(Y + 4864 | 0) + 4 >> 2] = m;
 c[(Y + 4864 | 0) + 8 >> 2] = 0;
 c[(Y + 4864 | 0) + 12 >> 2] = 0;
 c[(Y + 4864 | 0) + 16 >> 2] = r;
 c[(Y + 4864 | 0) + 20 >> 2] = m;
 c[(Y + 4864 | 0) + 24 >> 2] = c[((Y + 4920 | 0) + 8 | 0) >> 2];
 c[(Y + 4864 | 0) + 28 >> 2] = c[((Y + 4920 | 0) + 12 | 0) >> 2];
 c[(Y + 4864 | 0) + 32 >> 2] = c[((Y + 4920 | 0) + 16 | 0) >> 2];
 a[(Y + 4864 | 0) + 36 >> 0] = a[((Y + 4920 | 0) + 20 | 0) >> 0] | 0;
 m = c[Q >> 2] | 0;
 c[n >> 2] = m;
 c[o >> 2] = c[N >> 2];
 if (m | 0) c[m >> 2] = (c[m >> 2] | 0) + 1;
 c[((Y + 4864 | 0) + 40 | 0) >> 2] = c[((Y + 4920 | 0) + 24 | 0) >> 2];
 p = D + 276 | 0;
 r = Y + 4864 | 0;
 q = p + 44 | 0;
 do {
 ...
 c[D + 392 >> 2] = c[D + 292 >> 2];
 c[D + 396 >> 2] = c[D + 296 >> 2];
 ab(c[(Y + 4920 | 0) >> 2] | 0, c[((Y + 4920 | 0) + 4 | 0) >> 2] | 0);
 Lb(Y + 4864 | 0 | 0);
 switch (c[((Y + 4920 | 0) + 8 | 0) >> 2] | 0) {
 case 4:
 case 2:
 case 0:
 case 6:
 ...
 c[(Y + 4864 | 0) >> 2] = m;
 r = c[((Y + 4920 | 0) + 12 | 0) >> 2] | 0;
 c[(Y + 4864 | 0) + 4 >> 2] = (r + -11 | 0) >>> 0 < 2 & 1;
 c[(Y + 4864 | 0) + 8 >> 2] = (r | 0) == 12 & 1;
 o = (c[((Y + 4920 | 0) + 16 | 0) >> 2] | 0) > 1 & 1;
 c[(Y + 4864 | 0) + 12 >> 2] = o;
 c[(Y + 4864 | 0) + 16 >> 2] = 0;
 c[(Y + 4864 | 0) + 20 >> 2] = 0;
 c[(Y + 4040 | 0) >> 2] = m;
 c[(Y + 4040 | 0) + 4 >> 2] = (r + -11 | 0) >>> 0 < 2 & 1;
 c[(Y + 4040 | 0) + 8 >> 2] = (r | 0) == 12 & 1;
 c[(Y + 4040 | 0) + 12 >> 2] = o;
 He(5645, Y + 4040 | 0);
 o = xb(0, Y + 4864 | 0 | 0) | 0;
 c[D + 408 >> 2] = o;
 ...
 if (!m) Ie(6026, Y + 4800 | 0); else {
  ...
  We(Y + 4440 | 0, 6368, 0, h - 6368 | 0);
  j = c[(Y + 4768 | 0) >> 2] | 0;
  k = m;
  l = (m | 0) == 0;
  if (l) h = 0; else h = c[k + 4 >> 2] | 0;
  We(Y + 4440 | 0, (j | 0) == 0 ? 22051 : j, 0, h);
  j = c[(Y + 4440 | 0) >> 2] | 0;
  i : do if (j | 0) {
   h = uf(j, 6368) | 0;
   if (!h) break;
   while (1) {
    A = h + 1 | 0;
    a[A + (j - A + (c[((Y + 4440 | 0) + 8 | 0) >> 2] | 0)) >> 0] = 0;
    a[h >> 0] = 10;
    h = uf(h, 6368) | 0;
    if (!h) break i;
    j = c[(Y + 4440 | 0) >> 2] | 0;
 ...
 j : do if (!k) {
  ...
  if (!h) {
   ...
   f = uf(e, 5885) | 0;
   a[22047] = (f - e | 0) != -1 & (f | 0) != 0 & 1;
   f = uf(e, 5900) | 0;
   f = (f | 0) == 0 ? 0 : (f - e | 0) != -1;
   a[22049] = f & 1;
   h = uf(e, 5918) | 0;
   a[22050] = (h - e | 0) != -1 & (h | 0) != 0 & 1;
   h = uf(e, 5932) | 0;
   if (!h) {
    a[22048] = 0;
    if (f) {
 ...
 c[f + 440 >> 2] = D + 1568 | 0;
 c[f + 444 >> 2] = D + 1632 | 0;
 c[(f + 504 | 0) >> 2] = c[(Y + 4920 | 0) >> 2];
 c[(f + 504 | 0) + 4 >> 2] = c[(Y + 4920 | 0) + 4 >> 2];
 c[(f + 504 | 0) + 8 >> 2] = c[(Y + 4920 | 0) + 8 >> 2];
 c[(f + 504 | 0) + 12 >> 2] = c[(Y + 4920 | 0) + 12 >> 2];
 c[(f + 504 | 0) + 16 >> 2] = c[(Y + 4920 | 0) + 16 >> 2];
 c[(f + 504 | 0) + 20 >> 2] = c[(Y + 4920 | 0) + 20 >> 2];
 c[(f + 504 | 0) + 24 >> 2] = c[(Y + 4920 | 0) + 24 >> 2];
 if ((f + 532 | 0 | 0) != (Q | 0)) {
  e = c[(f + 532 | 0) >> 2] | 0;
  if (e | 0) {
   M = c[e >> 2] | 0;
 ...
 c[n + 1304 >> 2] = D + 1568 | 0;
 c[n + 1308 >> 2] = D + 1632 | 0;
 m = c[((Y + 4920 | 0) + 88 | 0) >> 2] | 0;
 b[n + 1452 >> 1] = 1;
 e = (c[(n + 1468 | 0) >> 2] | 0) - (c[n + 1464 >> 2] | 0) + m | 0;
 if ((e | 0) > (c[(n + 1460 | 0) >> 2] | 0)) ld(n + 1456 | 0, e);
 c[(n + 1472 | 0) >> 2] = 0;
 c[(n + 1476 | 0) >> 2] = 0;
 ...
 a[n + 1440 >> 0] = 1;
 m = c[((Y + 4920 | 0) + 92 | 0) >> 2] | 0;
 b[n + 1516 >> 1] = 2;
 e = (c[(n + 1532 | 0) >> 2] | 0) - (c[n + 1528 >> 2] | 0) + m | 0;
 if ((e | 0) > (c[(n + 1524 | 0) >> 2] | 0)) qd(n + 1520 | 0, e);
 c[(n + 1536 | 0) >> 2] = 0;
 c[(n + 1540 | 0) >> 2] = 0;
 ...
 a[n + 1504 >> 0] = 1;
 m = c[((Y + 4920 | 0) + 84 | 0) >> 2] | 0;
 b[n + 1580 >> 1] = 0;
 e = (c[(n + 1596 | 0) >> 2] | 0) - (c[n + 1592 >> 2] | 0) + m | 0;
 if ((e | 0) > (c[(n + 1588 | 0) >> 2] | 0)) rd(n + 1584 | 0, e);
 c[(n + 1600 | 0) >> 2] = 0;
 c[(n + 1604 | 0) >> 2] = 0;
...
function je(f) {
 f = f | 0;
 var h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0, C = 0, E = 0, F = 0, G = 0;
 F = c[f + 5504 >> 2] | 0;
 G = c[f + 8184 >> 2] | 0;
 Id(f + 8 | 0, f + 5416 | 0, f + 3064 | 0);
 c[(f + 5416 | 0) >> 2] = 0;
 c[(f + 5220 | 0) >> 2] = 0;
 c[(f + 5220 | 0) + 4 >> 2] = 0;
 c[(f + 5220 | 0) + 8 >> 2] = -1;
 ...
 h = c[(f + 5220 | 0) >> 2] | 0;
 c[(f + 5220 | 0) >> 2] = h + 1;
 Ve(f + 5436 | 0, f + 5216 | 0);
 c[((f + 5436 | 0) + 4 | 0) >> 2] = 0;
 c[(f + 5436 | 0) + 8 >> 2] = 0;
 if ((f + 5436 | 0 | 0) != ((f + 5220 | 0) + 4 + (h * 12 | 0) | 0 | 0)) {
  c[((f + 5220 | 0) + 4 + (h * 12 | 0) | 0) >> 2] = 0;
  Ve((f + 5220 | 0) + 4 + (h * 12 | 0) | 0, f + 5436 | 0);
  c[(f + 5436 | 0) >> 2] = 0;
 }
 E = c[((f + 5436 | 0) + 4 | 0) + 4 >> 2] | 0;
 c[((f + 5220 | 0) + 4 + (h * 12 | 0) + 4 | 0) >> 2] = c[((f + 5436 | 0) + 4 | 0) >> 2];
 c[((f + 5220 | 0) + 4 + (h * 12 | 0) + 4 | 0) + 4 >> 2] = E;
 c[(f + 5216 | 0) >> 2] = 0;
 Ue(f + 5212 | 0, 10185);
 h = c[((f + 8 | 0) + 2632 | 0) >> 2] | 0;
 c[((f + 8 | 0) + 2632 | 0) >> 2] = h + 1;
 if (((f + 8 | 0) + 2636 + (h * 204 | 0) | 0 | 0) != (f + 5212 | 0 | 0)) {
  c[((f + 8 | 0) + 2636 + (h * 204 | 0) | 0) >> 2] = 0;
  Ve((f + 8 | 0) + 2636 + (h * 204 | 0) | 0, f + 5212 | 0);
 }
 c[((f + 8 | 0) + 2636 + (h * 204 | 0) + 4 | 0) >> 2] = c[(f + 5220 | 0) >> 2];
 if (((f + 8 | 0) + 2636 + (h * 204 | 0) + 4 | 0 | 0) != (f + 5220 | 0 | 0)) {
  i = 0;
  do {
   z = (f + 8 | 0) + 2636 + (h * 204 | 0) + 8 + (i * 12 | 0) | 0;
   c[z >> 2] = 0;
   Ve(z, (f + 5220 | 0) + 4 + (i * 12 | 0) | 0);
   z = (f + 5220 | 0) + 4 + (i * 12 | 0) + 4 | 0;
   A = c[z + 4 >> 2] | 0;
   E = (f + 8 | 0) + 2636 + (h * 204 | 0) + 8 + (i * 12 | 0) + 4 | 0;
   c[E >> 2] = c[z >> 2];
   c[E + 4 >> 2] = A;
   i = i + 1 | 0;
  } while ((i | 0) != 16);
 }
 c[(f + 8 | 0) + 2636 + (h * 204 | 0) + 200 >> 2] = 1;
 Cd(f + 3056 | 0, (c[5344] | 0) + 1168 | 0, f + 8 | 0);
 c[(f + 8 | 0) + 3028 >> 2] = 0;
 c[(f + 8 | 0) + 3016 >> 2] = 0;
 c[(f + 8 | 0) + 3004 >> 2] = 0;
 c[(f + 8 | 0) + 2992 >> 2] = 0;
 ...
 c[(f + 8 | 0) >> 2] = 0;
 c[(f + 5436 | 0) >> 2] = 0;
 Ve(f + 4792 | 0, f + 5436 | 0);
 c[(f + 4792 | 0) + 4 >> 2] = -1;
 c[((f + 4792 | 0) + 8 | 0) >> 2] = 0;
 c[((f + 4792 | 0) + 8 | 0) + 4 >> 2] = 0;
 c[((f + 4792 | 0) + 8 | 0) >> 2] = 2013282306;
 b[((f + 4792 | 0) + 8 | 0) + 4 >> 1] = 192;
 g[(f + 4792 | 0) + 16 >> 2] = 1.0;
 g[(f + 4792 | 0) + 20 >> 2] = 1.0;
 g[(f + 4792 | 0) + 24 >> 2] = 1.0;
 g[(f + 4792 | 0) + 28 >> 2] = 1.0;
 b[(f + 4792 | 0) + 32 >> 1] = 28672;
 b[(f + 4792 | 0) + 34 >> 1] = 28672;
 A = (f + 4792 | 0) + 36 | 0;
 c[A >> 2] = 0;
 b[A >> 1] = 32647;
 b[A + 2 >> 1] = 255;
 b[((f + 4792 | 0) + 40 | 0) >> 1] = 296;
 a[(f + 4792 | 0) + 44 >> 0] = 17;
 a[(f + 4792 | 0) + 45 >> 0] = 13;
 a[((f + 4792 | 0) + 46 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 47 >> 0] = 13;
 a[((f + 4792 | 0) + 48 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 49 >> 0] = 13;
 a[((f + 4792 | 0) + 50 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 51 >> 0] = 13;
 a[((f + 4792 | 0) + 52 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 53 >> 0] = 13;
 a[((f + 4792 | 0) + 54 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 55 >> 0] = 13;
 a[((f + 4792 | 0) + 56 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 57 >> 0] = 13;
 a[((f + 4792 | 0) + 58 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 59 >> 0] = 13;
 a[((f + 4792 | 0) + 60 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 61 >> 0] = 13;
 a[((f + 4792 | 0) + 62 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 63 >> 0] = 13;
 a[((f + 4792 | 0) + 64 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 65 >> 0] = 13;
 a[((f + 4792 | 0) + 66 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 67 >> 0] = 13;
 a[((f + 4792 | 0) + 68 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 69 >> 0] = 13;
 a[((f + 4792 | 0) + 70 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 71 >> 0] = 13;
 a[((f + 4792 | 0) + 72 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 73 >> 0] = 13;
 a[((f + 4792 | 0) + 74 | 0) >> 0] = 17;
 a[(f + 4792 | 0) + 75 >> 0] = 13;
 a[((f + 4792 | 0) + 42 | 0) >> 0] = 0;
 a[(f + 4792 | 0) + 43 >> 0] = 1;
 a[((f + 4792 | 0) + 108 | 0) >> 0] = 0;
 a[(f + 4792 | 0) + 109 >> 0] = 0;
 z = (f + 4792 | 0) + 92 | 0;
 v = (f + 4792 | 0) + 76 | 0;
 b[z >> 1] = 65535;
 ...
 b[E + 14 >> 1] = 0;
 c[(f + 4792 | 0) + 316 >> 2] = 3;
 c[((f + 4792 | 0) + 320 | 0) >> 2] = -1;
 c[((f + 4792 | 0) + 320 | 0) + 4 >> 2] = -1;
 b[((f + 4792 | 0) + 42 | 0) >> 1] = d[(F + 8 | 0) >> 0] | d[(F + 8 | 0) + 1 >> 0] << 8;
 b[(f + 4792 | 0) + 44 >> 1] = d[(F + 10 | 0) >> 0] | d[(F + 10 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 46 | 0) >> 1] = d[(F + 12 | 0) >> 0] | d[(F + 12 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 48 | 0) >> 1] = d[(F + 14 | 0) >> 0] | d[(F + 14 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 50 | 0) >> 1] = d[(F + 16 | 0) >> 0] | d[(F + 16 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 52 | 0) >> 1] = d[(F + 18 | 0) >> 0] | d[(F + 18 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 54 | 0) >> 1] = d[(F + 20 | 0) >> 0] | d[(F + 20 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 56 | 0) >> 1] = d[(F + 22 | 0) >> 0] | d[(F + 22 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 58 | 0) >> 1] = d[(F + 24 | 0) >> 0] | d[(F + 24 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 60 | 0) >> 1] = d[(F + 26 | 0) >> 0] | d[(F + 26 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 62 | 0) >> 1] = d[(F + 28 | 0) >> 0] | d[(F + 28 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 64 | 0) >> 1] = d[(F + 30 | 0) >> 0] | d[(F + 30 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 66 | 0) >> 1] = d[(F + 32 | 0) >> 0] | d[(F + 32 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 68 | 0) >> 1] = d[(F + 34 | 0) >> 0] | d[(F + 34 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 70 | 0) >> 1] = d[(F + 36 | 0) >> 0] | d[(F + 36 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 72 | 0) >> 1] = d[(F + 38 | 0) >> 0] | d[(F + 38 | 0) + 1 >> 0] << 8;
 b[((f + 4792 | 0) + 74 | 0) >> 1] = d[(F + 40 | 0) >> 0] | d[(F + 40 | 0) + 1 >> 0] << 8;
 a[v >> 0] = a[(F + 42 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 77 >> 0] = a[(F + 43 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 78 >> 0] = a[(F + 44 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 79 >> 0] = a[(F + 45 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 80 >> 0] = a[(F + 46 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 81 >> 0] = a[(F + 47 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 82 >> 0] = a[(F + 48 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 83 >> 0] = a[(F + 49 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 84 >> 0] = a[(F + 50 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 85 >> 0] = a[(F + 51 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 86 >> 0] = a[(F + 52 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 87 >> 0] = a[(F + 53 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 88 >> 0] = a[(F + 54 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 89 >> 0] = a[(F + 55 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 90 >> 0] = a[(F + 56 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 91 >> 0] = a[(F + 57 | 0) >> 0] | 0;
 a[z >> 0] = a[(F + 58 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 93 >> 0] = a[(F + 59 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 94 >> 0] = a[(F + 60 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 95 >> 0] = a[(F + 61 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 96 >> 0] = a[(F + 62 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 97 >> 0] = a[(F + 63 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 98 >> 0] = a[(F + 64 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 99 >> 0] = a[(F + 65 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 100 >> 0] = a[(F + 66 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 101 >> 0] = a[(F + 67 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 102 >> 0] = a[(F + 68 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 103 >> 0] = a[(F + 69 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 104 >> 0] = a[(F + 70 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 105 >> 0] = a[(F + 71 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 106 >> 0] = a[(F + 72 | 0) >> 0] | 0;
 a[(f + 4792 | 0) + 107 >> 0] = a[(F + 73 | 0) >> 0] | 0;
 b[((f + 4792 | 0) + 108 | 0) >> 1] = d[(F + 74 | 0) >> 0] | d[(F + 74 | 0) + 1 >> 0] << 8;
 z = c[(f + 3056 | 0) + 4 >> 2] | 0;
 c[((f + 4792 | 0) + 320 | 0) >> 2] = c[(f + 3056 | 0) >> 2];
 c[((f + 4792 | 0) + 320 | 0) + 4 >> 2] = z;
 b[A >> 1] = b[A >> 1] & -64 | 7;
 A = (f + 4792 | 0) + 8 | 0;
 z = e[A + 4 >> 1] & 65535;
 v = c[A >> 2] & -2013267968 | 1879048521;
 c[A >> 2] = v;
 b[A + 4 >> 1] = z;
 E = c[5344] | 0;
 u = Uf(c[E + 476 >> 2] | 0, 0, 31) | 0;
 z = D & 15 | z & 65520;
 c[A >> 2] = u & -2147483648 | v & 2013264201;
 b[A + 4 >> 1] = z;
 Uf(c[E + 480 >> 2] | 0, 0, 36) | 0;
 c[A >> 2] = u & -2147483648 | v & 2013264201;
 b[A + 4 >> 1] = D & 496 | z & 65039;
 b[((f + 4792 | 0) + 40 | 0) >> 1] = (c[E + 484 >> 2] & 65535) << 8 & 3840 | b[((f + 4792 | 0) + 40 | 0) >> 1] & -3841;
 Dd(f, E + 1168 | 0, f + 4792 | 0);
 if ((F + 88 | 0 | 0) != (f | 0)) {
  E = c[f + 4 >> 2] | 0;
  c[(F + 88 | 0) >> 2] = c[f >> 2];
  c[(F + 88 | 0) + 4 >> 2] = E;
 ...
 while (1) {
  ...
  while (1) {
   A = (l << 10) + h | 0;
   a[E + A >> 0] = ((a[k >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 1) >> 0] = ((a[k + 1 >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 2) >> 0] = ((a[k + 2 >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 3) >> 0] = ((a[k + 3 >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 4) >> 0] = ((a[k + 4 >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 5) >> 0] = ((a[k + 5 >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 6) >> 0] = ((a[k + 6 >> 0] | 0) != 45) << 31 >> 31;
   a[E + (A | 7) >> 0] = ((a[k + 7 >> 0] | 0) != 45) << 31 >> 31;
   l = l + 1 | 0;
 ...
 a[(f + 3344 | 0) + 73 >> 0] = 3;
 c[(f + 5436 | 0) >> 2] = 0;
 Ve((f + 3344 | 0) + 76 | 0, f + 5436 | 0);
 c[((f + 3344 | 0) + 80 | 0) >> 2] = -1;
 c[((f + 3344 | 0) + 88 | 0) >> 2] = -1;
 c[((f + 3344 | 0) + 88 | 0) + 4 >> 2] = -1;
 Vf((f + 3344 | 0) + 96 | 0, 0, 584) | 0;
 a[((f + 3344 | 0) + 680 | 0) >> 0] = a[((f + 3344 | 0) + 680 | 0) >> 0] & -128;
 z = f + 4032 | 0;
 i = f + 3344 | 0;
 A = z + 36 | 0;
 do {
 ...
 h = c[((f + 3344 | 0) + 40 | 0) + 4 >> 2] | 0;
 c[((f + 4032 | 0) + 40 | 0) >> 2] = c[((f + 3344 | 0) + 40 | 0) >> 2];
 c[((f + 4032 | 0) + 40 | 0) + 4 >> 2] = h;
 h = (f + 4032 | 0) + 48 | 0;
 v = (f + 3344 | 0) + 48 | 0;
 c[h >> 2] = c[v >> 2];
 c[h + 4 >> 2] = c[v + 4 >> 2];
 ...
 c[h + 20 >> 2] = c[v + 20 >> 2];
 c[h + 24 >> 2] = c[v + 24 >> 2];
 Ve((f + 4032 | 0) + 76 | 0, (f + 3344 | 0) + 76 | 0);
 c[((f + 4032 | 0) + 80 | 0) >> 2] = c[((f + 3344 | 0) + 80 | 0) >> 2];
 v = c[((f + 3344 | 0) + 88 | 0) + 4 >> 2] | 0;
 c[((f + 4032 | 0) + 88 | 0) >> 2] = c[((f + 3344 | 0) + 88 | 0) >> 2];
 c[((f + 4032 | 0) + 88 | 0) + 4 >> 2] = v;
 sd((f + 4032 | 0) + 96 | 0, (f + 3344 | 0) + 96 | 0);
 a[((f + 4032 | 0) + 680 | 0) >> 0] = a[((f + 3344 | 0) + 680 | 0) >> 0] | 2;
 c[(f + 4032 | 0) + 4 >> 2] = 0;
 c[(f + 4032 | 0) + 8 >> 2] = 1024;
 c[(f + 4032 | 0) + 12 >> 2] = 8;
 c[(f + 4032 | 0) + 24 >> 2] = 1;
 ...
 c[(f + 4032 | 0) + 100 >> 2] = 1;
 c[(f + 3344 | 0) + 76 >> 2] = 0;
 b[((f + 4032 | 0) + 48 | 0) >> 1] = b[((f + 4032 | 0) + 48 | 0) >> 1] & -4048;
 c[(f + 4032 | 0) + 392 >> 2] = 8192;
 v = c[5344] | 0;
 ve(f + 3336 | 0, v + 1192 | 0, (f + 4032 | 0) + 76 | 0);
 do if ((c[(f + 3336 | 0) + 4 >> 2] | 0) == -1) {
  t = c[(v + 1576 | 0) >> 2] | 0;
  c[(v + 1576 | 0) >> 2] = t + 1;
  A = c[(v + 1616 | 0) >> 2] | 0;
  u = b[(c[v + 1608 >> 2] | 0) + (A << 1) >> 1] | 0;
  c[(v + 1616 | 0) >> 2] = A + 1;
  A = Uf(e[v + 1580 >> 1] | 0, 0, 16) | 0;
  t = t | D;
  c[(f + 3336 | 0) >> 2] = A | u & 65535;
  c[(f + 3336 | 0) + 4 >> 2] = t;
  c[(f + 4792 | 0) >> 2] = A | u & 65535;
  c[(f + 4792 | 0) + 4 >> 2] = t;
  c[(f + 4720 | 0) >> 2] = c[(c[v + 1168 >> 2] | 0) + ((c[v + 1180 >> 2] | 0) + -1 << 2) >> 2];
  te(v + 1192 | 0, (f + 4032 | 0) + 76 | 0, f + 4792 | 0, f + 4720 | 0);
  t = (c[(v + 1592 | 0) >> 2] | 0) + (e[(f + 3336 | 0) >> 1] | 0) | 0;
  u = c[(v + 1584 | 0) >> 2] | 0;
  c[u + (t * 776 | 0) + 8 >> 2] = 1;
  c[u + (t * 776 | 0) + 12 >> 2] = c[(v + 1572 | 0) >> 2];
  if ((u + (t * 776 | 0) | 0 | 0) != (f + 3336 | 0 | 0)) {
   A = c[(f + 3336 | 0) + 4 >> 2] | 0;
   c[(u + (t * 776 | 0) | 0) >> 2] = c[(f + 3336 | 0) >> 2];
   c[(u + (t * 776 | 0) | 0) + 4 >> 2] = A;
  }
  z = u + (t * 776 | 0) + 16 | 0;
  i = f + 4032 | 0;
  ...
  if ((u + (t * 776 | 0) + 16 | 0 | 0) == (f + 4032 | 0 | 0)) {
   ...
   h = c[((f + 4032 | 0) + 80 | 0) >> 2] | 0;
  } else {
   s = c[((f + 4032 | 0) + 40 | 0) + 4 >> 2] | 0;
   c[(u + (t * 776 | 0) + 56 | 0) >> 2] = c[((f + 4032 | 0) + 40 | 0) >> 2];
   c[(u + (t * 776 | 0) + 56 | 0) + 4 >> 2] = s;
   c[(u + (t * 776 | 0) + 64 | 0) >> 2] = c[h >> 2];
   c[(u + (t * 776 | 0) + 64 | 0) + 4 >> 2] = c[h + 4 >> 2];
   c[(u + (t * 776 | 0) + 64 | 0) + 8 >> 2] = c[h + 8 >> 2];
   c[(u + (t * 776 | 0) + 64 | 0) + 12 >> 2] = c[h + 12 >> 2];
   ...
   Ve(u + (t * 776 | 0) + 92 | 0, (f + 4032 | 0) + 76 | 0);
   h = c[((f + 4032 | 0) + 80 | 0) >> 2] | 0;
   s = c[((f + 4032 | 0) + 88 | 0) + 4 >> 2] | 0;
   c[(u + (t * 776 | 0) + 104 | 0) >> 2] = c[((f + 4032 | 0) + 88 | 0) >> 2];
   c[(u + (t * 776 | 0) + 104 | 0) + 4 >> 2] = s;
  }
  c[(u + (t * 776 | 0) + 96 | 0) >> 2] = h;
  h = c[((f + 4032 | 0) + 96 | 0) + 4 >> 2] | 0;
  c[(u + (t * 776 | 0) + 112 | 0) >> 2] = c[((f + 4032 | 0) + 96 | 0) >> 2];
  c[(u + (t * 776 | 0) + 112 | 0) + 4 >> 2] = h;
  h = 0;
  do {
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 4 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 4 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 8 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 8 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 12 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 12 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 16 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 16 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 20 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 20 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 24 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 24 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 28 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 28 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 32 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 32 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 36 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 36 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 40 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 40 >> 2];
   c[u + (t * 776 | 0) + 120 + (h * 48 | 0) + 44 >> 2] = c[(f + 4032 | 0) + 104 + (h * 48 | 0) + 44 >> 2];
   h = h + 1 | 0;
  } while ((h | 0) != 6);
  h = 0;
  do {
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 4 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 4 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 8 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 8 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 12 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 12 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 16 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 16 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 20 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 20 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 24 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 24 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 28 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 28 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 32 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 32 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 36 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 36 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 40 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 40 >> 2];
   c[u + (t * 776 | 0) + 408 + (h * 48 | 0) + 44 >> 2] = c[(f + 4032 | 0) + 392 + (h * 48 | 0) + 44 >> 2];
   h = h + 1 | 0;
  } while ((h | 0) != 6);
  s = a[((f + 4032 | 0) + 680 | 0) >> 0] | 0;
  a[u + (t * 776 | 0) + 696 >> 0] = s;
  a : do if (!(s & 2)) B = 6; else {
   q = c[(u + (t * 776 | 0) + 24 | 0) >> 2] | 0;
   r = c[(u + (t * 776 | 0) + 28 | 0) >> 2] | 0;
   h = c[(u + (t * 776 | 0) + 44 | 0) >> 2] | 0;
   b : do if ((h + -8 | 0) >>> 0 < 11) {
    if (!(2023 >>> ((h + -8 | 0) & 2047) & 1)) break;
    switch (h | 0) {
    case 10:
    case 9:
    case 8:
     {
      if (a[22044] | 0) break b;
      break;
     }
    case 16:
    case 15:
    ...
    case 13:
     {
      if (a[22045] | 0) break b;
      break;
     }
    default:
     {}
    }
    B = c[u + (t * 776 | 0) + 92 >> 2] | 0;
    c[(f + 5120 | 0) >> 2] = c[((B | 0) == 0 ? 1648 : B + 12 | 0) >> 2];
    Ie(5263, f + 5120 | 0);
    B = 4;
    break a;
   } while (0);
    ...
    e : do if ((o | 0) > 0) {
     if (p) {
      ...
      while (1) {
       k = q >> h;
       l = r >> h;
       db(m | 0, h | 0, w | 0, ((k | 0) == 0 ? 1 : k) | 0, ((l | 0) == 0 ? 1 : l) | 0, 0, c[u + (t * 776 | 0) + 408 + (i * 48 | 0) + (h << 2) >> 2] | 0, E + (c[u + (t * 776 | 0) + 120 + (i * 48 | 0) + (h << 2) >> 2] | 0) | 0);
       h = h + 1 | 0;
       if ((h | 0) == (o | 0)) break e;
      }
     } else l = 0;
     while (1) {
      ...
      Vb(m | 0, l | 0, w | 0, j | 0, k | 0, 0, x | 0, h | 0, E + (c[u + (t * 776 | 0) + 120 + (i * 48 | 0) + (l << 2) >> 2] | 0) | 0);
      l = l + 1 | 0;
      if ((l | 0) == (o | 0)) break e;
     }
    } while (0);
   ...
   if ((G | 0) == 220) {
    ...
    a[(f + 5436 | 0) + 41 >> 0] = 0;
    a[(f + 5436 | 0) + 42 >> 0] = 0;
    if ((u + (t * 776 | 0) + 92 | 0 | 0) != (f + 5436 | 0 | 0)) {
     c[(f + 5436 | 0) >> 2] = 0;
     Ve(f + 5436 | 0, u + (t * 776 | 0) + 92 | 0);
    }
    h = c[(u + (t * 776 | 0) + 96 | 0) >> 2] | 0;
    c[((f + 5436 | 0) + 4 | 0) >> 2] = h;
    c[i >> 2] = c[(u + (t * 776 | 0) + 20 | 0) >> 2];
    c[((f + 5436 | 0) + 12 | 0) >> 2] = c[(u + (t * 776 | 0) + 44 | 0) >> 2];
    c[((f + 5436 | 0) + 20 | 0) >> 2] = c[u + (t * 776 | 0) + 16 >> 2];
    c[((f + 5436 | 0) + 24 | 0) >> 2] = c[(u + (t * 776 | 0) + 24 | 0) >> 2];
    c[((f + 5436 | 0) + 28 | 0) >> 2] = c[(u + (t * 776 | 0) + 28 | 0) >> 2];
    c[((f + 5436 | 0) + 36 | 0) >> 2] = c[(u + (t * 776 | 0) + 40 | 0) >> 2];
    if ((f + 5436 | 0 | 0) != (u + (t * 776 | 0) + 704 | 0 | 0)) {
     c[(u + (t * 776 | 0) + 704 | 0) >> 2] = 0;
     Ve(u + (t * 776 | 0) + 704 | 0, f + 5436 | 0);
     h = c[((f + 5436 | 0) + 4 | 0) >> 2] | 0;
    }
    c[u + (t * 776 | 0) + 708 >> 2] = h;
  ...
  j = c[(v + 1584 | 0) >> 2] | 0;
  if ((c[(f + 3336 | 0) >> 2] | 0) == (c[(j + (i * 776 | 0) | 0) >> 2] | 0) ? (c[(f + 3336 | 0) + 4 >> 2] | 0) == (c[(j + (i * 776 | 0) | 0) + 4 >> 2] | 0) : 0) {
   c[j + (i * 776 | 0) + 8 >> 2] = B;
   c[j + (i * 776 | 0) + 12 >> 2] = c[(v + 1572 | 0) >> 2];
   break;
  } else {
   c[(f + 5192 | 0) >> 2] = h >>> 16;
   c[(f + 5192 | 0) + 4 >> 2] = h & 65535;
   Ie(4815, f + 5192 | 0);
   break;
  }
 } while (0);
 if ((F + 160 | 0 | 0) != (f + 3336 | 0 | 0)) {
  C = c[(f + 3336 | 0) + 4 >> 2] | 0;
  c[(F + 160 | 0) >> 2] = c[(f + 3336 | 0) >> 2];
  c[(F + 160 | 0) + 4 >> 2] = C;
 }
 wf(E);
 h = c[5344] | 0;
...
function $d(e) {
 e = e | 0;
 var f = 0, h = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0, C = 0, D = 0, E = 0, F = 0, G = 0, H = 0, I = 0, J = 0.0, K = 0.0, L = 0.0;
 F = 0;
 I = i;
 i = i + 8272 | 0;
 if (!(a[(e + 268 | 0) >> 0] | 0)) {
  ...
  if ((n | 0) == (o | 0)) {
   ...
   t = o + n | 0;
   if (o) {
    n = n - (c[(u + 1176 | 0) >> 2] | 0) | 0;
    o = vf(t << 2) | 0;
    p = c[(u + 1168 | 0) >> 2] | 0;
    if ((n | 0) > 0) {
     q = o;
     r = 0;
     s = p + (c[(u + 1176 | 0) >> 2] << 2) | 0;
     while (1) {
      c[q >> 2] = c[s >> 2];
      r = r + 1 | 0;
  ...
  c[(u + 1180 | 0) >> 2] = n + 1;
  c[(c[(u + 1168 | 0) >> 2] | 0) + (n << 2) >> 2] = v;
  c[e + 272 >> 2] = v;
  n = e + 10 + (a[(e + 74 | 0) >> 0] << 1) | 0;
  a[n >> 0] = 0;
  a[n + 1 >> 0] = 3;
  n = a[(e + 74 | 0) >> 0] | 0;
  a[(e + 58 | 0) >> 0] = n;
  a[(n << 24 >> 24) + (e + 42) >> 0] = a[(e + 75 | 0) >> 0] | 0;
  a[(e + 75 | 0) >> 0] = (d[(e + 75 | 0) >> 0] | 0) + 16;
  n = (a[(e + 74 | 0) >> 0] | 0) + 1 << 24 >> 24;
  a[(e + 74 | 0) >> 0] = n;
  a[(e + 10 + (n << 24 >> 24 << 1) | 0) >> 0] = 10;
  a[(e + 10 + (n << 24 >> 24 << 1) | 0) + 1 >> 0] = 7;
  n = a[(e + 74 | 0) >> 0] | 0;
  a[(e + 68 | 0) >> 0] = n;
  a[(n << 24 >> 24) + (e + 42) >> 0] = a[(e + 75 | 0) >> 0] | 0;
  a[(e + 75 | 0) >> 0] = (d[(e + 75 | 0) >> 0] | 0) + 4;
  a[(e + 74 | 0) >> 0] = (a[(e + 74 | 0) >> 0] | 0) + 1 << 24 >> 24;
  c[(I + 4792 | 0) >> 2] = -1;
  c[((I + 4792 | 0) + 4 | 0) >> 2] = -1;
  a[(I + 4792 | 0) + 10 >> 0] = 17;
  a[(I + 4792 | 0) + 11 >> 0] = 13;
  a[((I + 4792 | 0) + 12 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 13 >> 0] = 13;
  a[((I + 4792 | 0) + 14 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 15 >> 0] = 13;
  a[((I + 4792 | 0) + 16 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 17 >> 0] = 13;
  a[((I + 4792 | 0) + 18 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 19 >> 0] = 13;
  a[((I + 4792 | 0) + 20 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 21 >> 0] = 13;
  a[((I + 4792 | 0) + 22 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 23 >> 0] = 13;
  a[((I + 4792 | 0) + 24 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 25 >> 0] = 13;
  a[((I + 4792 | 0) + 26 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 27 >> 0] = 13;
  a[((I + 4792 | 0) + 28 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 29 >> 0] = 13;
  a[((I + 4792 | 0) + 30 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 31 >> 0] = 13;
  a[((I + 4792 | 0) + 32 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 33 >> 0] = 13;
  a[((I + 4792 | 0) + 34 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 35 >> 0] = 13;
  a[((I + 4792 | 0) + 36 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 37 >> 0] = 13;
  a[((I + 4792 | 0) + 38 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 39 >> 0] = 13;
  a[((I + 4792 | 0) + 40 | 0) >> 0] = 17;
  a[(I + 4792 | 0) + 41 >> 0] = 13;
  a[(I + 4792 | 0) + 8 >> 0] = 0;
  a[(I + 4792 | 0) + 9 >> 0] = 1;
  a[((I + 4792 | 0) + 74 | 0) >> 0] = 0;
  ...
  a[p + 12 >> 0] = 0;
  c[(I + 5436 | 0) >> 2] = 0;
  Ve((I + 4792 | 0) + 92 | 0, I + 5436 | 0);
  c[(I + 4792 | 0) + 96 >> 2] = -1;
  c[((I + 4792 | 0) + 104 | 0) >> 2] = -1;
  c[((I + 4792 | 0) + 104 | 0) + 4 >> 2] = -1;
  r = (I + 4792 | 0) + 120 | 0;
  s = r + 68 | 0;
  do {
   c[r >> 2] = 0;
  ...
  a[((I + 4792 | 0) + 188 | 0) >> 0] = a[((I + 4792 | 0) + 188 | 0) >> 0] & -16 | 4;
  c[(I + 4792 | 0) >> 2] = 2;
  c[((I + 4792 | 0) + 4 | 0) >> 2] = -1;
  c[p >> 2] = 57600;
  c[(I + 4792 | 0) + 80 >> 2] = 0;
  c[(I + 4792 | 0) + 84 >> 2] = 0;
  c[((I + 4792 | 0) + 112 | 0) >> 2] = -1;
  c[((I + 4792 | 0) + 116 | 0) >> 2] = -1;
  b[(I + 4792 | 0) + 8 >> 1] = d[(e + 8 | 0) >> 0] | d[(e + 8 | 0) + 1 >> 0] << 8;
  b[(I + 4792 | 0) + 10 >> 1] = d[(e + 10 | 0) >> 0] | d[(e + 10 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 12 | 0) >> 1] = d[(e + 12 | 0) >> 0] | d[(e + 12 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 14 | 0) >> 1] = d[(e + 14 | 0) >> 0] | d[(e + 14 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 16 | 0) >> 1] = d[(e + 16 | 0) >> 0] | d[(e + 16 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 18 | 0) >> 1] = d[(e + 18 | 0) >> 0] | d[(e + 18 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 20 | 0) >> 1] = d[(e + 20 | 0) >> 0] | d[(e + 20 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 22 | 0) >> 1] = d[(e + 22 | 0) >> 0] | d[(e + 22 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 24 | 0) >> 1] = d[(e + 24 | 0) >> 0] | d[(e + 24 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 26 | 0) >> 1] = d[(e + 26 | 0) >> 0] | d[(e + 26 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 28 | 0) >> 1] = d[(e + 28 | 0) >> 0] | d[(e + 28 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 30 | 0) >> 1] = d[(e + 30 | 0) >> 0] | d[(e + 30 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 32 | 0) >> 1] = d[(e + 32 | 0) >> 0] | d[(e + 32 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 34 | 0) >> 1] = d[(e + 34 | 0) >> 0] | d[(e + 34 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 36 | 0) >> 1] = d[(e + 36 | 0) >> 0] | d[(e + 36 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 38 | 0) >> 1] = d[(e + 38 | 0) >> 0] | d[(e + 38 | 0) + 1 >> 0] << 8;
  b[((I + 4792 | 0) + 40 | 0) >> 1] = d[(e + 40 | 0) >> 0] | d[(e + 40 | 0) + 1 >> 0] << 8;
  a[o >> 0] = a[(e + 42 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 43 >> 0] = a[(e + 43 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 44 >> 0] = a[(e + 44 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 45 >> 0] = a[(e + 45 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 46 >> 0] = a[(e + 46 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 47 >> 0] = a[(e + 47 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 48 >> 0] = a[(e + 48 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 49 >> 0] = a[(e + 49 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 50 >> 0] = a[(e + 50 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 51 >> 0] = a[(e + 51 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 52 >> 0] = a[(e + 52 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 53 >> 0] = a[(e + 53 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 54 >> 0] = a[(e + 54 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 55 >> 0] = a[(e + 55 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 56 >> 0] = a[(e + 56 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 57 >> 0] = a[(e + 57 | 0) >> 0] | 0;
  a[n >> 0] = a[(e + 58 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 59 >> 0] = a[(e + 59 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 60 >> 0] = a[(e + 60 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 61 >> 0] = a[(e + 61 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 62 >> 0] = a[(e + 62 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 63 >> 0] = a[(e + 63 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 64 >> 0] = a[(e + 64 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 65 >> 0] = a[(e + 65 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 66 >> 0] = a[(e + 66 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 67 >> 0] = a[(e + 67 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 68 >> 0] = a[(e + 68 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 69 >> 0] = a[(e + 69 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 70 >> 0] = a[(e + 70 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 71 >> 0] = a[(e + 71 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 72 >> 0] = a[(e + 72 | 0) >> 0] | 0;
  a[(I + 4792 | 0) + 73 >> 0] = a[(e + 73 | 0) >> 0] | 0;
  b[((I + 4792 | 0) + 74 | 0) >> 1] = d[(e + 74 | 0) >> 0] | d[(e + 74 | 0) + 1 >> 0] << 8;
  Bd(I + 4720 | 0, (c[5344] | 0) + 1168 | 0, I + 4792 | 0);
  if ((e + 96 | 0 | 0) != (I + 4720 | 0 | 0)) {
   v = c[(I + 4720 | 0) + 4 >> 2] | 0;
   c[(e + 96 | 0) >> 2] = c[(I + 4720 | 0) >> 2];
   c[(e + 96 | 0) + 4 >> 2] = v;
  }
  Ue(I + 4792 | 0, 10148);
  c[(I + 4792 | 0) + 4 >> 2] = -2;
  ...
  a[((I + 4720 | 0) + 8 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 9 >> 0] = 13;
  a[((I + 4720 | 0) + 10 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 11 >> 0] = 13;
  a[((I + 4720 | 0) + 12 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 13 >> 0] = 13;
  a[((I + 4720 | 0) + 14 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 15 >> 0] = 13;
  a[((I + 4720 | 0) + 16 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 17 >> 0] = 13;
  a[((I + 4720 | 0) + 18 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 19 >> 0] = 13;
  a[((I + 4720 | 0) + 20 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 21 >> 0] = 13;
  a[((I + 4720 | 0) + 22 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 23 >> 0] = 13;
  a[((I + 4720 | 0) + 24 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 25 >> 0] = 13;
  a[((I + 4720 | 0) + 26 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 27 >> 0] = 13;
  a[((I + 4720 | 0) + 28 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 29 >> 0] = 13;
  a[((I + 4720 | 0) + 30 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 31 >> 0] = 13;
  a[((I + 4720 | 0) + 32 | 0) >> 0] = 17;
  a[(I + 4720 | 0) + 33 >> 0] = 13;
  a[(I + 4720 | 0) >> 0] = 0;
  a[(I + 4720 | 0) + 1 >> 0] = 1;
  p = (I + 4720 | 0) + 50 | 0;
  ...
  c[m >> 2] = n;
  c[(I + 8 | 0) + 60 >> 2] = c[(I + 3344 | 0) >> 2];
  l = n;
  if (n | 0) c[l >> 2] = (c[l >> 2] | 0) + 1;
  b[((I + 8 | 0) + 256 | 0) >> 1] = b[(I + 4720 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 258 | 0) >> 1] = b[((I + 4720 | 0) + 2 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 260 | 0) >> 1] = b[((I + 4720 | 0) + 4 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 262 | 0) >> 1] = b[((I + 4720 | 0) + 6 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 264 | 0) >> 1] = b[((I + 4720 | 0) + 8 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 266 | 0) >> 1] = b[((I + 4720 | 0) + 10 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 268 | 0) >> 1] = b[((I + 4720 | 0) + 12 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 270 | 0) >> 1] = b[((I + 4720 | 0) + 14 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 272 | 0) >> 1] = b[((I + 4720 | 0) + 16 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 274 | 0) >> 1] = b[((I + 4720 | 0) + 18 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 276 | 0) >> 1] = b[((I + 4720 | 0) + 20 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 278 | 0) >> 1] = b[((I + 4720 | 0) + 22 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 280 | 0) >> 1] = b[((I + 4720 | 0) + 24 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 282 | 0) >> 1] = b[((I + 4720 | 0) + 26 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 284 | 0) >> 1] = b[((I + 4720 | 0) + 28 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 286 | 0) >> 1] = b[((I + 4720 | 0) + 30 | 0) >> 1] | 0;
  b[((I + 8 | 0) + 288 | 0) >> 1] = b[((I + 4720 | 0) + 32 | 0) >> 1] | 0;
  x = b[q >> 1] | 0;
  a[((I + 8 | 0) + 290 | 0) >> 0] = x;
  a[((I + 8 | 0) + 291 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 36 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 292 | 0) >> 0] = x;
  a[((I + 8 | 0) + 293 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 38 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 294 | 0) >> 0] = x;
  a[((I + 8 | 0) + 295 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 40 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 296 | 0) >> 0] = x;
  a[((I + 8 | 0) + 297 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 42 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 298 | 0) >> 0] = x;
  a[((I + 8 | 0) + 299 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 44 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 300 | 0) >> 0] = x;
  a[((I + 8 | 0) + 301 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 46 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 302 | 0) >> 0] = x;
  a[((I + 8 | 0) + 303 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 48 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 304 | 0) >> 0] = x;
  a[((I + 8 | 0) + 305 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[p >> 1] | 0;
  a[((I + 8 | 0) + 306 | 0) >> 0] = x;
  a[((I + 8 | 0) + 307 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 52 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 308 | 0) >> 0] = x;
  a[((I + 8 | 0) + 309 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 54 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 310 | 0) >> 0] = x;
  a[((I + 8 | 0) + 311 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 56 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 312 | 0) >> 0] = x;
  a[((I + 8 | 0) + 313 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 58 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 314 | 0) >> 0] = x;
  a[((I + 8 | 0) + 315 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 60 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 316 | 0) >> 0] = x;
  a[((I + 8 | 0) + 317 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 62 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 318 | 0) >> 0] = x;
  a[((I + 8 | 0) + 319 | 0) >> 0] = (x & 65535) >>> 8;
  x = b[((I + 4720 | 0) + 64 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 320 | 0) >> 0] = x;
  a[((I + 8 | 0) + 321 | 0) >> 0] = (x & 65535) >>> 8;
  b[((I + 8 | 0) + 322 | 0) >> 1] = b[((I + 4720 | 0) + 66 | 0) >> 1] | 0;
  if (n | 0) {
   x = c[l >> 2] | 0;
   c[l >> 2] = x - 1;
   if ((x | 0) == 1) {
  ...
  z = b[q >> 1] | 0;
  a[((I + 8 | 0) + 290 | 0) >> 0] = z;
  a[((I + 8 | 0) + 291 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 36 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 292 | 0) >> 0] = z;
  a[((I + 8 | 0) + 293 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 38 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 294 | 0) >> 0] = z;
  a[((I + 8 | 0) + 295 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 40 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 296 | 0) >> 0] = z;
  a[((I + 8 | 0) + 297 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 42 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 298 | 0) >> 0] = z;
  a[((I + 8 | 0) + 299 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 44 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 300 | 0) >> 0] = z;
  a[((I + 8 | 0) + 301 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 46 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 302 | 0) >> 0] = z;
  a[((I + 8 | 0) + 303 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 48 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 304 | 0) >> 0] = z;
  a[((I + 8 | 0) + 305 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[p >> 1] | 0;
  a[((I + 8 | 0) + 306 | 0) >> 0] = z;
  a[((I + 8 | 0) + 307 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 52 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 308 | 0) >> 0] = z;
  a[((I + 8 | 0) + 309 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 54 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 310 | 0) >> 0] = z;
  a[((I + 8 | 0) + 311 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 56 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 312 | 0) >> 0] = z;
  a[((I + 8 | 0) + 313 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 58 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 314 | 0) >> 0] = z;
  a[((I + 8 | 0) + 315 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 60 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 316 | 0) >> 0] = z;
  a[((I + 8 | 0) + 317 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 62 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 318 | 0) >> 0] = z;
  a[((I + 8 | 0) + 319 | 0) >> 0] = (z & 65535) >>> 8;
  z = b[((I + 4720 | 0) + 64 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 320 | 0) >> 0] = z;
  a[((I + 8 | 0) + 321 | 0) >> 0] = (z & 65535) >>> 8;
  b[((I + 8 | 0) + 322 | 0) >> 1] = b[((I + 4720 | 0) + 66 | 0) >> 1] | 0;
  if (l | 0) {
   z = c[j >> 2] | 0;
   c[j >> 2] = z - 1;
  ...
  B = b[q >> 1] | 0;
  a[((I + 8 | 0) + 290 | 0) >> 0] = B;
  a[((I + 8 | 0) + 291 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 36 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 292 | 0) >> 0] = B;
  a[((I + 8 | 0) + 293 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 38 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 294 | 0) >> 0] = B;
  a[((I + 8 | 0) + 295 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 40 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 296 | 0) >> 0] = B;
  a[((I + 8 | 0) + 297 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 42 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 298 | 0) >> 0] = B;
  a[((I + 8 | 0) + 299 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 44 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 300 | 0) >> 0] = B;
  a[((I + 8 | 0) + 301 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 46 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 302 | 0) >> 0] = B;
  a[((I + 8 | 0) + 303 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 48 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 304 | 0) >> 0] = B;
  a[((I + 8 | 0) + 305 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[p >> 1] | 0;
  a[((I + 8 | 0) + 306 | 0) >> 0] = B;
  a[((I + 8 | 0) + 307 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 52 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 308 | 0) >> 0] = B;
  a[((I + 8 | 0) + 309 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 54 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 310 | 0) >> 0] = B;
  a[((I + 8 | 0) + 311 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 56 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 312 | 0) >> 0] = B;
  a[((I + 8 | 0) + 313 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 58 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 314 | 0) >> 0] = B;
  a[((I + 8 | 0) + 315 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 60 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 316 | 0) >> 0] = B;
  a[((I + 8 | 0) + 317 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 62 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 318 | 0) >> 0] = B;
  a[((I + 8 | 0) + 319 | 0) >> 0] = (B & 65535) >>> 8;
  B = b[((I + 4720 | 0) + 64 | 0) >> 1] | 0;
  a[((I + 8 | 0) + 320 | 0) >> 0] = B;
  a[((I + 8 | 0) + 321 | 0) >> 0] = (B & 65535) >>> 8;
  b[((I + 8 | 0) + 322 | 0) >> 1] = b[((I + 4720 | 0) + 66 | 0) >> 1] | 0;
  if (j | 0) {
   B = c[f >> 2] | 0;
   c[f >> 2] = B - 1;
  ...
  a[(I + 3064 | 0) + 200 >> 0] = 10;
  c[(I + 3064 | 0) + 204 >> 2] = 1;
  c[(I + 3064 | 0) >> 2] = 2124503556;
  c[(I + 3064 | 0) + 4 >> 2] = -923214409;
  Ue(I + 5420 | 0, 10162);
  kd(I + 3064 | 0, I + 5420 | 0, 1);
  c[(I + 5420 | 0) >> 2] = 0;
  Ue(I + 5416 | 0, 10172);
  c[I + 5504 >> 2] = e;
  c[I + 8152 >> 2] = r;
 ...
 if ((F | 0) == 284) {
  ...
  g : while (1) {
   f = a[C + n >> 0] | 0;
   h : do if ((f & 255) < 32) switch (f & 255 | 0) {
   case 8:
    {
     l = n;
     f = (m | 0) > 0 ? m + -1 | 0 : 0;
     ...
     case 2:
      {
       ...
       l = j;
       f = m;
       j = d[C + (n + 3) >> 0] << 8 | d[C + (n + 2) >> 0] | d[C + (n + 4) >> 0] << 16 | d[C + j >> 0] << 24;
       break h;
      }
     default:
      {
   ...
   default:
    ...
    g[e + 276 + (k * 20 | 0) >> 2] = K;
    L = +(h & 255);
    g[e + 276 + (k * 20 | 0) + 4 >> 2] = L;
    g[e + 276 + (k * 20 | 0) + 8 >> 2] = +(f & 255 & 127 & 255);
    g[e + 276 + (k * 20 | 0) + 12 >> 2] = 0.0;
    c[e + 276 + (k * 20 | 0) + 16 >> 2] = j;
    l = k + 1 | 0;
    B = m + 1 | 0;
    g[e + 276 + (l * 20 | 0) >> 2] = +(B & 255);
    g[e + 276 + (l * 20 | 0) + 4 >> 2] = L;
    g[e + 276 + (l * 20 | 0) + 8 >> 2] = +((f & 255 & 127) + 1 & 255);
    g[e + 276 + (l * 20 | 0) + 12 >> 2] = 0.0;
    c[e + 276 + (l * 20 | 0) + 16 >> 2] = j;
    l = k + 2 | 0;
    g[e + 276 + (l * 20 | 0) >> 2] = +(B & 255);
    J = +(h + 1 & 255);
    g[e + 276 + (l * 20 | 0) + 4 >> 2] = J;
    g[e + 276 + (l * 20 | 0) + 8 >> 2] = +((f & 255 & 127) + 1 & 255);
    g[e + 276 + (l * 20 | 0) + 12 >> 2] = 1.0;
    c[e + 276 + (l * 20 | 0) + 16 >> 2] = j;
    l = k + 3 | 0;
    g[e + 276 + (l * 20 | 0) >> 2] = K;
    g[e + 276 + (l * 20 | 0) + 4 >> 2] = L;
    g[e + 276 + (l * 20 | 0) + 8 >> 2] = +(f & 255 & 127 & 255);
    g[e + 276 + (l * 20 | 0) + 12 >> 2] = 0.0;
    c[e + 276 + (l * 20 | 0) + 16 >> 2] = j;
    l = k + 4 | 0;
    g[e + 276 + (l * 20 | 0) >> 2] = +(B & 255);
  ...
  if ((H | 0) > 0) {
   ...
   g[(I + 4792 | 0) + 4 >> 2] = 0.0;
   h = c[5344] | 0;
   L = +g[e + 4 >> 2] * (8.0 / +(c[h + 472 >> 2] | 0) * 2.0);
   g[(I + 4792 | 0) >> 2] = 8.0 / +(c[h + 468 >> 2] | 0) * 2.0 * +g[e >> 2];
   g[(I + 4792 | 0) + 4 >> 2] = L;
   jd(e + 96 | 0, e + 276 | 0, $(d[e + 75 >> 0] | 0, H) | 0);
   id(e + 88 | 0);
   h = c[5344] | 0;
   c[(h + 132 | 0) >> 2] = (c[(h + 132 | 0) >> 2] | 0) + 1;
   Pd(c[h + 628 >> 2] | 0, I + 4792 | 0);
   h = c[5344] | 0;
   c[(h + 148 | 0) >> 2] = (c[(h + 148 | 0) >> 2] | 0) + 1;
   f = c[h + 628 >> 2] | 0;
   i : do if (f | 0) {
    f = c[f + 604 >> 2] | 0;
    switch (c[(c[h + 632 >> 2] | 0) + 288 >> 2] | 0) {
    case 0:
     {
      Ib(f | 0, 0, H | 0);
      break i;
   ...
   do {
    ...
    if ((h | 0) > 0) {
     ...
     do {
      ...
      c[v + 3068 + (f + d + j << 2) >> 2] = hc(m | 0, c[((s | 0) == 0 ? 1648 : s + 12 | 0) >> 2] | 0) | 0;
      d = d + 1 | 0;
     } while ((d | 0) != (h | 0));
    }
    k = k + 1 | 0;
   ...
   do {
    ...
    if ((h | 0) > 0) {
     ...
     while (1) {
      ...
      s = hc(m | 0, c[((s | 0) == 0 ? 1648 : s + 12 | 0) >> 2] | 0) | 0;
      c[v + 3580 + (j + k << 2) >> 2] = f;
      Hb(s | 0, f | 0);
      k = k + 1 | 0;
...
function vf(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   g = f + 8 | 0;
   h = c[g >> 2] | 0;
   do if ((d | 0) == (h | 0)) c[5386] = k & ~(1 << b); else {
    if (h >>> 0 < (c[5390] | 0) >>> 0) Sb();
    a = h + 12 | 0;
    if ((c[a >> 2] | 0) == (f | 0)) {
     c[a >> 2] = d;
     c[e >> 2] = h;
  ...
  if (p >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (g | 0) {
     ...
     c[o + 24 >> 2] = g;
     a = c[k + 16 >> 2] | 0;
     do if (a | 0) if (a >>> 0 < b >>> 0) Sb(); else {
      c[o + 16 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     } while (0);
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[5390] | 0) >>> 0) Sb(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (j >>> 0 < ((c[5388] | 0) - p | 0) >>> 0) {
    ...
    do if (j >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (b >>> 0 < (c[5390] | 0) >>> 0) Sb(); else {
      c[b >> 2] = h;
      c[h + 24 >> 2] = e;
      c[h + 12 >> 2] = h;
      c[h + 8 >> 2] = h;
 ...
 if ((w | 0) == 191) {
  a = (c[5494] | 0) + g | 0;
  c[5494] = a;
  if (a >>> 0 > (c[5495] | 0) >>> 0) c[5495] = a;
  l = c[5392] | 0;
  do if (!l) {
   C = c[5390] | 0;
   if ((C | 0) == 0 | h >>> 0 < C >>> 0) c[5390] = h;
   c[5498] = h;
   c[5499] = g;
   c[5501] = 0;
   c[5395] = c[5504];
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (l | 0)) {
     ...
     if ((w | 0) == 276) if (b >>> 0 < (c[5390] | 0) >>> 0) Sb(); else {
      c[b >> 2] = m;
      c[m + 24 >> 2] = e;
      c[m + 12 >> 2] = m;
      c[m + 8 >> 2] = m;
   ...
   if ((b | 0) != (l | 0)) {
    ...
    if ((w | 0) == 302) if (b >>> 0 < (c[5390] | 0) >>> 0) Sb(); else {
     c[b >> 2] = l;
     c[l + 24 >> 2] = e;
     c[l + 12 >> 2] = l;
     c[l + 8 >> 2] = l;
 ...
 if (!(c[5374] | 0)) a = 21540; else a = c[(Xf() | 0) + 64 >> 2] | 0;
 c[a >> 2] = 12;
 C = 0;
 i = D;
 return C | 0;
...
function Vd(e, f) {
 ...
 if ((h + (l + m | 0) | 0 | 0) > (c[(f + 492 | 0) >> 2] | 0)) {
  k = vf(h + (l + m | 0) | 0) | 0;
  j = c[(f + 488 | 0) >> 2] | 0;
  if ((j | 0) > 0) Tf(k | 0, c[(f + 496 | 0) >> 2] | 0, j | 0) | 0;
  j = c[(f + 496 | 0) >> 2] | 0;
  if (j | 0) wf(j);
  c[(f + 496 | 0) >> 2] = k;
...
function hf(e, f, g, j, l) {
 ...
 a : while (1) {
  do if ((m | 0) > -1) {
   ...
   if (!(c[5374] | 0)) m = 21540; else m = c[(Xf() | 0) + 64 >> 2] | 0;
   c[m >> 2] = 75;
   m = -1;
  } while (0);
  f = a[x >> 0] | 0;
  ...
  case 109:
   {
    if (!(c[5374] | 0)) f = 21540; else f = c[(Xf() | 0) + 64 >> 2] | 0;
    n = c[f >> 2] | 0;
    f = 0;
    while (1) {
     if ((d[19217 + f >> 0] | 0) == (n | 0)) {
      L = 85;
      break;
     }
     f = f + 1 | 0;
  ...
  case 101:
   {
    ...
    do if (E >>> 0 < 2146435072 | (E | 0) == 2146435072 & 0 < 0) {
     ...
     if ((B | 0) == 97) {
      ...
      q = r + v | 0;
      nf(e, 32, J, q, H);
      if (!(c[e >> 2] & 32)) jf(x, v, e);
      nf(e, 48, J, q, H ^ 65536);
      n = f - Y | 0;
      if (!(c[e >> 2] & 32)) jf(ea, n, e);
      f = ba - o | 0;
      nf(e, 48, r - (n + f) | 0, 0, 0);
      if (!(c[e >> 2] & 32)) jf(s, f, e);
      nf(e, 32, J, q, H ^ 8192);
      f = (q | 0) < (J | 0) ? J : q;
      break;
     }
     ...
     if ((n | 0) > 0) {
      ...
      while (1) {
       ...
       do if (n >>> 0 >= q >>> 0) {
        o = 0;
        do {
         z = Uf(c[n >> 2] | 0, 0, s | 0) | 0;
         z = Rf(z | 0, D | 0, o | 0, 0) | 0;
         A = D;
         y = dg(z | 0, A | 0, 1e9, 0) | 0;
         c[n >> 2] = y;
         o = cg(z | 0, A | 0, 1e9, 0) | 0;
         n = n + -4 | 0;
        } while (n >>> 0 >= q >>> 0);
        if (!o) break;
        q = q + -4 | 0;
     ...
     do if (s) {
      ...
      if ((f | 0) > -1) {
       ...
       do {
        ...
        o = T - n | 0;
        if (!(c[e >> 2] & 32)) jf(n, (f | 0) > (o | 0) ? o : f, e);
        f = f - o | 0;
        q = q + 4 | 0;
       } while (q >>> 0 < s >>> 0 & (f | 0) > -1);
      }
     ...
     if (!(f & 32)) jf(r ? (s ? 21143 : 21147) : s ? 21135 : 21139, 3, e);
     nf(e, 32, J, q, H ^ 8192);
     f = (q | 0) < (J | 0) ? J : q;
    } while (0);
    n = f;
  ...
  n = (J | 0) < (r | 0) ? r : J;
  nf(e, 32, n, r, o);
  if (!(c[e >> 2] & 32)) jf(u, v, e);
  nf(e, 48, n, r, o ^ 65536);
  nf(e, 48, q, s, 0);
  if (!(c[e >> 2] & 32)) jf(f, s, e);
  nf(e, 32, n, r, o ^ 8192);
  r = K;
  x = I;
 }
...
function ke(b, d, e) {
 ...
 if (a[e + 1409 >> 0] | 0) if ((ae(e + 1416 | 0, u) | 0) == 5) {
  a[e + 1289 >> 0] = 1;
  d = e + 1420 | 0;
  b = c[d >> 2] | 0;
  d = c[d + 4 >> 2] | 0;
  ...
  if ((h | 0) != (m | 0)) {
   ...
   if (b | 0) {
    ...
    do {
     t = c[b + 24 >> 2] | 0;
     Hc[c[(c[t >> 2] | 0) + 24 >> 2] & 31](t, v);
     b = b + 32 | 0;
    } while ((b | 0) != (d | 0));
   }
  }
 }
 if (a[e + 1410 >> 0] | 0) if ((ae(e + 1592 | 0, u) | 0) == 5) {
  a[e + 1290 >> 0] = 1;
  d = e + 1596 | 0;
  b = c[d >> 2] | 0;
  d = c[d + 4 >> 2] | 0;
...
function Zc(b) {
 ...
 d = l + 704 | 0;
 e = c[d >> 2] | 0;
 if ((e | 0) == (l + 688 | 0)) Gc[c[(c[e >> 2] | 0) + 16 >> 2] & 127](e); else if (e | 0) Gc[c[(c[e >> 2] | 0) + 20 >> 2] & 127](e);
 c[d >> 2] = 0;
 j = c[5361] | 0;
 _b(0, 0, 1, 0) | 0;
 Ab(0, 0, 1, 0) | 0;
 ...
 if (!e) d = j + 1364 | 0; else {
  ...
  if ((f | 0) < (c[d >> 2] | 0)) {
   while (1) {
    g = c[e + (f << 5) + 24 >> 2] | 0;
    if ((g | 0) == (e + (f << 5) + 8 | 0)) Gc[c[(c[g >> 2] | 0) + 16 >> 2] & 127](g); else if (g | 0) Gc[c[(c[g >> 2] | 0) + 20 >> 2] & 127](g);
    f = f + 1 | 0;
 ...
 c[d >> 2] = 0;
 d = c[j + 704 >> 2] | 0;
 if ((d | 0) == (j + 688 | 0)) Gc[c[(c[d >> 2] | 0) + 16 >> 2] & 127](d); else if (d | 0) Gc[c[(c[d >> 2] | 0) + 20 >> 2] & 127](d);
 i = j + 660 | 0;
 c[j + 676 >> 2] = 0;
 c[j + 680 >> 2] = 0;
 e = c[i >> 2] | 0;
 ...
 if (a[e >> 0] | 0) {
  a[e >> 0] = 0;
  Ed((c[5344] | 0) + 1168 | 0, c[d + 272 >> 2] | 0);
  d = c[5360] | 0;
 }
 e = d + 268 | 0;
 if (a[e >> 0] | 0) {
 ...
 wf(d);
 c[5360] = 0;
 Ed((c[5344] | 0) + 1168 | 0, -2);
 Te(c[5363] | 0, c[(c[5344] | 0) + 156 >> 2] | 0);
 e = c[5344] | 0;
 k = e + 416 | 0;
 Nd(k);
 na(0);
 ...
 if (!e) d = l + 344 | 0; else {
  ...
  if ((f | 0) < (c[d >> 2] | 0)) {
   while (1) {
    g = c[e + (f << 5) + 24 >> 2] | 0;
    do if ((g | 0) == (e + (f << 5) + 8 | 0)) Gc[c[(c[g >> 2] | 0) + 16 >> 2] & 127](g); else {
     if (!g) break;
     Gc[c[(c[g >> 2] | 0) + 20 >> 2] & 127](g);
    } while (0);
    f = f + 1 | 0;
    if ((f | 0) >= (c[d >> 2] | 0)) break;
    e = c[i >> 2] | 0;
 ...
 if ((x | 0) == 15) {
  ...
  if (!((h | 0) == (k | 0) ? (c[s + 4 >> 2] | 0) == (c[t + 4 >> 2] | 0) : 0)) {
   ...
   if (!(((h ^ l) & 16762878 | 0) == 0 & 0 == 0)) {
    s = Wf(l | 0, k & 65535 | 0, 1) | 0;
    s = c[1488 + ((s & 31) << 2) >> 2] | 0;
    t = Wf(l | 0, k & 65535 | 0, 6) | 0;
    t = c[1488 + ((t & 31) << 2) >> 2] | 0;
    m = Wf(l | 0, k & 65535 | 0, 14) | 0;
    m = c[1488 + ((m & 31) << 2) >> 2] | 0;
    h = Wf(l | 0, k & 65535 | 0, 19) | 0;
    Bb(s | 0, t | 0, m | 0, c[1488 + ((h & 31) << 2) >> 2] | 0);
    h = c[o >> 2] | 0;
    l = c[p >> 2] | 0;
    m = e[o + 4 >> 1] | 0;
    k = e[p + 4 >> 1] | 0;
   ...
   if (((h ^ l) & 117454848 | 0) == 0 & 0 == 0) n = m; else {
    n = Wf(l | 0, k & 65535 | 0, 11) | 0;
    n = c[1548 + ((n & 7) << 2) >> 2] | 0;
    k = Wf(l | 0, k & 65535 | 0, 24) | 0;
    Ac(n | 0, c[1548 + ((k & 7) << 2) >> 2] | 0);
    k = e[p + 4 >> 1] | 0;
    l = c[p >> 2] | 0;
    n = e[o + 4 >> 1] | 0;
    h = c[o >> 2] | 0;
   }
   m = Wf(l | 0, k & 65535 | 0, 27) | 0;
   t = Wf(h | 0, n & 65535 | 0, 27) | 0;
   if (!(((t ^ m) & 15 | 0) == 0 & 0 == 0)) {
    r = Wf(l | 0, k & 65535 | 0, 30) | 0;
    s = Wf(l | 0, k & 65535 | 0, 29) | 0;
    t = Wf(l | 0, k & 65535 | 0, 28) | 0;
    tc(r & 1 | 0, s & 1 | 0, t & 1 | 0, m & 1 | 0);
   }
   r = p;
   s = c[r + 4 >> 2] | 0;
   t = o;
  ...
  if ((x | 0) == 50) {
   ...
   c[l + 8 >> 2] = c[k + 8 >> 2];
   c[l + 12 >> 2] = c[k + 12 >> 2];
   xc(+(+g[l >> 2]), +(+g[h >> 2]), +(+g[u + 684 >> 2]), +(+g[u + 688 >> 2]));
  }
  m = j + 56 | 0;
  h = b[m >> 1] | 0;
  n = u + 656 | 0;
  ...
  do {
   ...
   if ((x | 0) == 82) {
    ...
    if (!(a[j + 348 + (t << 4) + 1 >> 0] | 0)) {
     ...
     Sa(h & 255 | 0, d[j + 348 + (t << 4) + 5 >> 0] | 0, c[j + 348 + (t << 4) + 12 >> 2] | 0, a[j + 348 + (t << 4) + 6 >> 0] | 0, d[j + 348 + (t << 4) + 4 >> 0] | 0, c[j + 348 + (t << 4) + 8 >> 2] | 0);
     if (!(a[u + 848 + (t << 4) + 1 >> 0] | 0)) Rb(d[k >> 0] | 0);
    }
    h = a[j + 348 + (t << 4) + 3 >> 0] | 0;
    if (!((a[22049] | 0) == 0 ? 1 : (a[u + 848 + (t << 4) + 3 >> 0] | 0) == h << 24 >> 24)) nc(d[r >> 0] | 0, h & 255 | 0);
    c[s >> 2] = c[r >> 2];
    c[s + 4 >> 2] = c[r + 4 >> 2];
    c[s + 8 >> 2] = c[r + 8 >> 2];
    c[s + 12 >> 2] = c[r + 12 >> 2];
...
function Wc(d) {
 d = d | 0;
 var f = 0, j = 0, k = 0, l = 0, m = 0.0, n = 0.0, o = 0.0, p = 0, q = 0.0, r = 0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = 0, B = 0, C = 0, E = 0.0, F = 0.0, G = 0.0, H = 0.0, I = 0.0, J = 0.0, K = 0.0;
 C = i;
 i = i + 176 | 0;
 A = C + 8 | 0;
 y = C;
 ...
 f = (c[p >> 2] | 0) + 1 | 0;
 c[p >> 2] = f;
 E = +(f | 0) * .009999999776482582;
 n = +yf(E) * 10.0;
 E = +xf(E) * 10.0;
 o = 0.0 - n;
 K = 0.0 - E;
 m = 1.0 / +P(+(o * o + 6.25 + K * K));
 o = o * m;
 q = m * -2.5;
 m = K * m;
 K = q * 0.0;
 ...
 g[d + 248 >> 2] = -m;
 g[d + 252 >> 2] = 0.0;
 g[d + 256 >> 2] = -(E * K + (n * J + I * 2.5));
 g[d + 260 >> 2] = -(E * H + (n * G + F * 2.5));
 g[d + 264 >> 2] = E * m + (n * o + q * 2.5);
 c[d + 268 >> 2] = 1065353216;
 Xc(j, d + 272 | 0, d + 208 | 0);
 Xc(s, j, d + 336 | 0);
 j = d + 400 | 0;
 f = s;
 p = j + 64 | 0;
 ...
 if (!(a[z >> 0] | 0)) {
  ...
  K = +mb() * 1.0e3;
  t = ~~K >>> 0;
  u = +O(K) >= 1.0 ? (K > 0.0 ? ~~+aa(+N(K / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((K - +(~~K >>> 0)) / 4294967296.0) >>> 0) : 0;
  l = d + 488 | 0;
  j = c[l >> 2] | 0;
  v = d + 472 | 0;
  if ((j | 0) > 0) {
   ...
   do {
    if ((f | 0) < 1048576) {
     ...
     do {
      $c(s);
      m = +((c[s >> 2] | 0) >>> 0) * 2.3283064365386963e-10 + -.5;
      n = +((c[p >> 2] | 0) >>> 0) * 2.3283064365386963e-10 + -.5;
      o = +((c[r >> 2] | 0) >>> 0) * 2.3283064365386963e-10 + -.5;
     } while (+P(+(m * m + n * n + o * o)) > .5);
     f = c[v >> 2] | 0;
     g[d + 16777708 + (f << 4) >> 2] = m;
     g[d + 16777708 + (f << 4) + 4 >> 2] = n + 2.0;
     g[d + 16777708 + (f << 4) + 8 >> 2] = o;
     g[d + 16777708 + (f << 4) + 12 >> 2] = 0.0;
     f = (c[v >> 2] | 0) + 1 | 0;
     c[v >> 2] = f;
     j = c[l >> 2] | 0;
    }
  ...
  if ((f | 0) > 0) {
   r = 0;
   do {
    f = d + 16777708 + (r << 4) + 4 | 0;
    m = +g[f >> 2] + -.01666666753590107;
    g[f >> 2] = m;
    j = d + 16777708 + (r << 4) | 0;
    n = +g[j >> 2];
    k = d + 16777708 + (r << 4) + 8 | 0;
    o = +g[k >> 2];
    l = d + 16777708 + (r << 4) + 12 | 0;
    q = +g[l >> 2];
    p = d + 492 + (r << 4) | 0;
    g[p >> 2] = n * .01666666753590107 + +g[p >> 2];
    p = d + 492 + (r << 4) + 4 | 0;
    K = m * .01666666753590107 + +g[p >> 2];
    g[p >> 2] = K;
    s = d + 492 + (r << 4) + 8 | 0;
    g[s >> 2] = o * .01666666753590107 + +g[s >> 2];
    s = d + 492 + (r << 4) + 12 | 0;
    g[s >> 2] = q * .01666666753590107 + +g[s >> 2];
    if (K < -2.0) {
     g[p >> 2] = -1.7999999523162842;
     g[j >> 2] = n * .800000011920929;
     g[f >> 2] = m * -.800000011920929;
     g[k >> 2] = o * .800000011920929;
     g[l >> 2] = q * .800000011920929;
    }
    r = r + 1 | 0;
   } while ((r | 0) < (c[v >> 2] | 0));
  }
  m = +mb() * 1.0e3;
  t = Qf(~~m >>> 0 | 0, (+O(m) >= 1.0 ? (m > 0.0 ? ~~+aa(+N(m / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((m - +(~~m >>> 0)) / 4294967296.0) >>> 0) : 0) | 0, t | 0, u | 0) | 0;
  u = D;
  m = +mb() * 1.0e3;
  s = +O(m) >= 1.0 ? (m > 0.0 ? ~~+aa(+N(m / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((m - +(~~m >>> 0)) / 4294967296.0) >>> 0) : 0;
  jd(d + 56 | 0, d + 492 | 0, c[v >> 2] << 4);
  n = +mb() * 1.0e3;
  s = Qf(~~n >>> 0 | 0, (+O(n) >= 1.0 ? (n > 0.0 ? ~~+aa(+N(n / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((n - +(~~n >>> 0)) / 4294967296.0) >>> 0) : 0) | 0, ~~m >>> 0 | 0, s | 0) | 0;
  m = +(s >>> 0) + 4294967296.0 * +(D | 0);
  n = +(t >>> 0) + 4294967296.0 * +(u | 0);
 }
 K = +mb() * 1.0e3;
 s = ~~K >>> 0;
 t = +O(K) >= 1.0 ? (K > 0.0 ? ~~+aa(+N(K / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((K - +(~~K >>> 0)) / 4294967296.0) >>> 0) : 0;
 r = c[5344] | 0;
 l = r + 116 | 0;
 c[l >> 2] = (c[l >> 2] | 0) + 1;
 l = c[r + 424 >> 2] | 0;
 ...
 k = r + 692 | 0;
 l = r + 696 | 0;
 if (!(c[k >> 2] | 0)) if (!(c[l >> 2] | 0)) if ((c[r + 700 >> 2] | 0) == (f | 0)) {
  if ((c[r + 704 >> 2] | 0) != (j | 0)) B = 30;
 } else B = 30; else B = 30; else B = 30;
 if ((B | 0) == 30) {
  c[k >> 2] = 0;
  c[l >> 2] = 0;
  c[r + 700 >> 2] = f;
 ...
 a : do if (j | 0) {
  ...
  if ((c[k + 296 >> 2] | 0) > 0) {
   ...
   case 0:
    {
     if (!(a[22049] | 0)) break a;
     jb(f | 0, c[l >> 2] | 0, c[k + 304 >> 2] | 0, p | 0);
     break a;
    }
   case 2:
    {
   ...
   if (a[22049] | 0) Ha(f | 0, c[k + 304 >> 2] | 0, w | 0, x | 0, p | 0);
  }
 } while (0);
 K = +mb() * 1.0e3;
 k = Qf(~~K >>> 0 | 0, (+O(K) >= 1.0 ? (K > 0.0 ? ~~+aa(+N(K / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((K - +(~~K >>> 0)) / 4294967296.0) >>> 0) : 0) | 0, s | 0, t | 0) | 0;
 l = D;
 $d(c[5360] | 0);
 j = c[5344] | 0;
 a[j + 448 >> 0] = 0;
 ...
 f = c[5361] | 0;
 j = f + 1288 | 0;
 if (!(a[f + 624 >> 0] | 0)) B = 49; else if (!(a[f + 652 >> 0] & 1)) B = 49;
 if ((B | 0) == 49) {
  B = b[j >> 1] | 0;
  if ((B & 255) << 24 >> 24 == 0 | (B & 65535) < 256) {
   H = +mb();
   H = H * 1.0e3;
   w = ~~H >>> 0;
   y = +O(H) >= 1.0 ? (H > 0.0 ? ~~+aa(+N(H / 4294967296.0), 4294967295.0) >>> 0 : ~~+_((H - +(~~H >>> 0)) / 4294967296.0) >>> 0) : 0;
   B = d + 480 | 0;
   z = B;
   d = z;
   d = c[d >> 2] | 0;
...
function wf(a) {
 ...
 do if (!(a & 1)) {
  ...
  if (!g) {
   ...
   if (!a) {
    q = k;
    f = j;
   } else if (a >>> 0 < (c[5390] | 0) >>> 0) Sb(); else {
    c[i + 20 >> 2] = a;
    c[a + 24 >> 2] = i;
    q = k;
    f = j;
 ...
 if (!(b & 2)) {
  ...
  do if (b >>> 0 < 256) {
   ...
   a = 21584 + (e << 1 << 2) | 0;
   if ((b | 0) != (a | 0)) {
    if (b >>> 0 < (c[5390] | 0) >>> 0) Sb();
    if ((c[b + 12 >> 2] | 0) != (m | 0)) Sb();
   }
   if ((d | 0) == (b | 0)) {
    c[5386] = c[5386] & ~(1 << e);
    break;
   ...
   if ((d | 0) == (a | 0)) l = d + 8 | 0; else {
    if (d >>> 0 < (c[5390] | 0) >>> 0) Sb();
    a = d + 8 | 0;
    if ((c[a >> 2] | 0) == (m | 0)) l = a; else Sb();
   }
   c[b + 12 >> 2] = d;
   c[l >> 2] = b;
  } else {
 ...
 do if (!(a & b)) {
  ...
  if ((a | 0) == 127) if (b >>> 0 < (c[5390] | 0) >>> 0) Sb(); else {
   c[b >> 2] = q;
   c[q + 24 >> 2] = e;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
...
function Pe(b, d) {
  ...
  if (!g) {
   ...
   if ((m | 0) > 0) {
    ...
    do {
     ...
     l = l + 40 | 0;
     e = c[h >> 2] | 0;
     if ((e | 0) == (f | 0)) Gc[c[(c[f >> 2] | 0) + 16 >> 2] & 127](f); else if (e | 0) Gc[c[(c[e >> 2] | 0) + 20 >> 2] & 127](e);
     k = k + 1 | 0;
    } while ((k | 0) != (m | 0));
   }
   e = c[b >> 2] | 0;
 ...
 f = c[f >> 2] | 0;
 if ((f | 0) == (g | 0)) Gc[c[(c[v >> 2] | 0) + 16 >> 2] & 127](g); else if (f | 0) Gc[c[(c[f >> 2] | 0) + 20 >> 2] & 127](f);
 a[e + 32 >> 0] = a[d + 32 >> 0] | 0;
 i = w;
 return;
}
...
function Dd(f, g, h) {
 ...
 c[q + 28 >> 2] = c[p + 28 >> 2];
 b[q + 32 >> 1] = b[p + 32 >> 1] | 0;
 ud(s + (r * 608 | 0) + 58 | 0, h + 42 | 0);
 ud(s + (r * 608 | 0) + 126 | 0, h + 110 | 0);
 ud(s + (r * 608 | 0) + 194 | 0, h + 178 | 0);
 ud(s + (r * 608 | 0) + 262 | 0, h + 246 | 0);
 q = s + (r * 608 | 0) + 332 | 0;
 c[q >> 2] = c[h + 316 >> 2];
 if (k) {
  j = s + (r * 608 | 0) + 336 | 0;
...
function eg(a, b, d, e, f) {
 ...
 if (!h) {
  ...
  do {
   ...
   e = a << 1 | e >>> 31 | 0;
   n = a >>> 31 | b << 1 | 0;
   Qf(k | 0, d | 0, e | 0, n | 0) | 0;
   p = D;
   o = p >> 31 | ((p | 0) < 0 ? -1 : 0) << 1;
   i = o & 1;
   a = Qf(e | 0, n | 0, o & m | 0, (((p | 0) < 0 ? -1 : 0) >> 31 | ((p | 0) < 0 ? -1 : 0) << 1) & l | 0) | 0;
   b = D;
   h = h - 1 | 0;
  } while ((h | 0) != 0);
  k = j;
...
function De(a) {
 ...
 do {
  ...
  if (!(c[5374] | 0)) b = 21540; else b = c[(Xf() | 0) + 64 >> 2] | 0;
 } while ((c[b >> 2] | 0) == 4);
 i = r;
 return;
}
 ...
 case 5:
  {
   ...
   j = h > -1.0 ? h : -1.0;
   e = i > -1.0 ? i : -1.0;
   f = +Sf(+((l < 1.0 ? l : 1.0) * 127.0));
   h = +Sf(+((k < 1.0 ? k : 1.0) * 127.0));
   j = +Sf(+((j < 1.0 ? j : 1.0) * 127.0));
   d = ~~+Sf(+((e < 1.0 ? e : 1.0) * 127.0));
   a[c >> 0] = ~~f;
   a[c + 1 >> 0] = ~~h;
   a[c + 2 >> 0] = ~~j;
   a[c + 3 >> 0] = d;
 ...
 case 7:
  {
   ...
   l = h > 0.0 ? h : 0.0;
   h = i > 0.0 ? i : 0.0;
   j = +Sf(+((j < 1.0 ? j : 1.0) * 255.0));
   k = +Sf(+((k < 1.0 ? k : 1.0) * 255.0));
   l = +Sf(+((l < 1.0 ? l : 1.0) * 255.0));
   d = ~~+Sf(+((h < 1.0 ? h : 1.0) * 255.0)) & 255;
   a[c >> 0] = ~~j;
   a[c + 1 >> 0] = ~~k;
   a[c + 2 >> 0] = ~~l;
   a[c + 3 >> 0] = d;
 ...
 case 11:
  {
   ...
   l = h > -1.0 ? h : -1.0;
   h = i > -1.0 ? i : -1.0;
   j = +Sf(+((j < 1.0 ? j : 1.0) * 32767.0));
   k = +Sf(+((k < 1.0 ? k : 1.0) * 32767.0));
   l = +Sf(+((l < 1.0 ? l : 1.0) * 32767.0));
   d = ~~+Sf(+((h < 1.0 ? h : 1.0) * 32767.0));
   b[c >> 1] = ~~j;
   b[c + 2 >> 1] = ~~k;
   b[c + 4 >> 1] = ~~l;
   b[c + 6 >> 1] = d;
 ...
 case 0:
  {
   ...
   if ((c[f >> 2] | 0) > 0) {
    ...
    d = a + 24 | 0;
    i = d;
    i = Qf(c[e >> 2] | 0, c[e + 4 >> 2] | 0, c[i >> 2] | 0, c[i + 4 >> 2] | 0) | 0;
 ...
 case 2:
  {
   ...
   h = a + 24 | 0;
   i = h;
   if (!((+((Qf(e | 0, f | 0, c[i >> 2] | 0, c[i + 4 >> 2] | 0) | 0) >>> 0) + 4294967296.0 * +(D | 0)) / 1.0e3 < 250.0)) {
    a = 0;
    return a | 0;
   }
   k = +g[b + 24 >> 2] - +g[a + 40 >> 2];
...
function $c(a) {
 ...
 b = 21344;
 b = bg(c[b >> 2] | 0, c[b + 4 >> 2] | 0, 1284865837, 1481765933) | 0;
 b = Rf(b | 0, D | 0, 1, 0) | 0;
 o = D;
 l = Wf(b | 0, o | 0, 33) | 0;
 o = bg(b | 0, o | 0, 1284865837, 1481765933) | 0;
 o = Rf(o | 0, D | 0, 1, 0) | 0;
 b = D;
 h = Wf(o | 0, b | 0, 33) | 0;
 b = bg(o | 0, b | 0, 1284865837, 1481765933) | 0;
 b = Rf(b | 0, D | 0, 1, 0) | 0;
 o = D;
 d = Wf(b | 0, o | 0, 33) | 0;
 o = bg(b | 0, o | 0, 1284865837, 1481765933) | 0;
...
function Pd(a, b) {
 ...
 b : while (1) {
  ...
  case 1:
   {
    tb(h | 0, +(+g[f >> 2]), +(+g[f + 4 >> 2]));
    break c;
   }
  case 2:
   {
    bb(h | 0, +(+g[f >> 2]), +(+g[f + 4 >> 2]), +(+g[f + 8 >> 2]));
    break c;
   }
  case 3:
   {
...
function af(a, b, d) {
 ...
 while (1) {
  if (!(c[5374] | 0)) {
   ...
   b = Qa(146, n | 0) | 0;
   if (b >>> 0 > 4294963200) {
    if (!(c[5374] | 0)) e = 21540; else e = c[(Xf() | 0) + 64 >> 2] | 0;
    c[e >> 2] = 0 - b;
    b = -1;
   }
  } else {
...
function Oe(b) {
 ...
 do {
  ...
  Pe(g, l);
  b = c[j >> 2] | 0;
  if ((b | 0) == (h | 0)) Gc[c[(c[h >> 2] | 0) + 16 >> 2] & 127](h); else if (b | 0) Gc[c[(c[b >> 2] | 0) + 20 >> 2] & 127](b);
  f = f + 40 | 0;
 } while ((f | 0) != (m | 0));
 b = c[n >> 2] | 0;
 if (!b) {
...
function Se(b, d) {
 ...
 Pe(g, h);
 b = c[b >> 2] | 0;
 if ((b | 0) == (f | 0)) Gc[c[(c[f >> 2] | 0) + 16 >> 2] & 127](f); else if (b | 0) Gc[c[(c[b >> 2] | 0) + 20 >> 2] & 127](b);
 b = c[e >> 2] | 0;
 if ((b | 0) == (j | 0)) {
  Gc[c[(c[j >> 2] | 0) + 16 >> 2] & 127](j);
  i = l;
  return k | 0;
 }
 if (!b) {
...
function Wd(b, e, f) {
 ...
 if (!(a[b + 68 >> 0] | 0)) {
  ...
  do {
   o = a[h >> 0] | 0;
   n = $(d[k >> 0] | 0, l + f | 0) | 0;
   Xd((c[j >> 2] | 0) + (n + (d[b + 230 + o >> 0] | 0)) | 0, a[b + 198 + (o << 1) + 1 >> 0] | 0, p, q, r, s) | 0;
   l = l + 1 | 0;
  } while ((l | 0) < (c[e >> 2] | 0));
  i = t;
  return;
  ...
  do {
   ...
   u = a[m >> 0] | 0;
   v = $(d[h >> 0] | 0, n + f | 0) | 0;
   Xd((c[e >> 2] | 0) + (v + (d[b + 230 + u >> 0] | 0)) | 0, a[b + 198 + (u << 1) + 1 >> 0] | 0, +((c[o >> 2] | 0) >>> 0) * 2.3283064365386963e-10 + 0.0, +((c[k >> 2] | 0) >>> 0) * 2.3283064365386963e-10 + 0.0, +((c[l >> 2] | 0) >>> 0) * 2.3283064365386963e-10 + 0.0, 1.0) | 0;
   n = n + 1 | 0;
  } while ((n | 0) < (c[j >> 2] | 0));
  i = t;
  return;
...
function Od(a, d, e) {
 ...
 if ((p | 0) == 8) $a(e | 0, c[1456 + (g << 2) >> 2] | 0, c[1456 + (i << 2) >> 2] | 0, c[1456 + (f << 2) >> 2] | 0);
 a = b[o >> 1] & 255;
...
function fe(e, f, g) {
 ...
 if ((e | 0) != (f | 0)) {
  ...
  if (h | 0) {
   ...
   do {
    h = c[e + 24 >> 2] | 0;
    Hc[c[(c[h >> 2] | 0) + 24 >> 2] & 31](h, k);
    e = e + 32 | 0;
   } while ((e | 0) != (j | 0));
  }
 }
 e = c[g + 704 >> 2] | 0;
 if (!e) m = 10; else if ((Lc[c[(c[e >> 2] | 0) + 24 >> 2] & 0](e, k) | 0) == 1) {
  Yb(0, 0) | 0;
  e = 1;
 } else m = 10;
 if ((m | 0) == 10) {
...
function jf(b, d, e) {
 ...
 a : do if ((h | 0) == 5) {
  ...
  b : do if ((a[e + 75 >> 0] | 0) > -1) {
   ...
   if ((Ec[c[e + 36 >> 2] & 127](e, b, h) | 0) >>> 0 < h >>> 0) break a;
   g = d - h | 0;
   b = b + h | 0;
   f = c[i >> 2] | 0;
  } else g = d; while (0);
...
function ag(a, b, d, e) {
 ...
 a = Qf(h ^ a | 0, g ^ b | 0, h | 0, g | 0) | 0;
 b = D;
 eg(a, b, Qf(l ^ d | 0, k ^ e | 0, l | 0, k | 0) | 0, D, j) | 0;
 e = Qf(c[j >> 2] ^ h | 0, c[j + 4 >> 2] ^ g | 0, h | 0, g | 0) | 0;
 d = D;
 i = f;
 return (D = d, e) | 0;
}
...
function $f(a, b, c, d) {
 ...
 h = Qf(j ^ a | 0, i ^ b | 0, j | 0, i | 0) | 0;
 g = D;
 a = f ^ j;
 b = e ^ i;
 return Qf((eg(h, g, Qf(f ^ c | 0, e ^ d | 0, f | 0, e | 0) | 0, D, 0) | 0) ^ a | 0, D ^ b | 0, a | 0, b | 0) | 0;
}
...
function pf(a, b) {
 ...
 case 0:
  {
   if (a != 0.0) {
    a = +pf(a * 18446744073709551616.0, b);
    d = (c[b >> 2] | 0) + -64 | 0;
   } else d = 0;
   c[b >> 2] = d;
   break;
...
function Ef(a, b, d, e, f, g) {
 ...
 f = f | 0;
 g = g | 0;
 if ((a | 0) == (c[b + 8 >> 2] | 0)) Ff(b, d, e, f); else {
  a = c[a + 8 >> 2] | 0;
...
// EMSCRIPTEN_END_FUNCS
 ...
 var Ec = [ og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, df, cf, ff, og, og, og, og, Df, og, og, og, og, og, og, og, og, og, og, og, be, ce, de, ee, fe, ge, he, ke, le, me, og, Rd, og, og, af, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og, og ];
 var Fc = [ pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, Kf, pg, pg, pg, Gf, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg, pg ];
 var Gc = [ qg, qg, qg, qg, qg, qg, qg, qg, De, bd, cd, qg, qg, fd, gd, hd, vd, qg, qg, yd, zd, Ad, ne, qg, qg, qe, re, se, qg, qg, qg, qg, qg, qg, qg, zf, If, Bf, Cf, qg, qg, qg, qg, Af, qg, qg, qg, Mf, Nf, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, Uc, qg, Ge, bf, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg, qg ];
 var Hc = [ rg, rg, rg, rg, rg, rg, rg, rg, rg, rg, rg, rg, ed, rg, rg, rg, rg, rg, xd, rg, rg, rg, rg, rg, pe, rg, rg, rg, rg, rg, rg, rg ];
 var Ic = [ sg, we, xe, ye, Yc, Wc, Zc, Ce, sg, sg, sg, dd, sg, sg, sg, sg, sg, wd, sg, sg, sg, sg, sg, oe, sg, sg, sg, sg, ze, Ae, Be, $e, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, Of, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg, sg ];
 var Jc = [ tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, Ee, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg, tg ];
 var Kc = [ ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, Jf, ug, ug, ug, Ef, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug, ug ];
 var Lc = [ vg ];
 var Mc = [ wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, Lf, wg, wg, wg, Hf, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg, wg ];
 return {
  _i64Subtract: Qf,
  _free: wf,
  _main: Vc,
  ...
  _roundf: Sf,
  _bitshift64Shl: Uf,
  __GLOBAL__sub_I_Instancing_cc: ad,
  __GLOBAL__sub_I_Log_cc: Fe,
  runPostSets: Pf,
  stackAlloc: Nc,
  stackSave: Oc,
  stackRestore: Pc,
